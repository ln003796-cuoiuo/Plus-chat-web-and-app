...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (org.pluschapluschat.russenger.BuildConfig.DEBUG) {
            return;
        }
        try {
            if (BuildVars.DEBUG_VERSION) {
                ...
                crashlytics.setCustomKey("version", getVersionName(org.pluschapluschat.russenger.BuildConfig.VERSION_NUM));
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = org.pluschapluschat.russenger.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(org.pluschapluschat.russenger.BuildConfig.BETA_URL);
    }

...
import static org.pluschapluschat.russenger.AndroidUtilities.isInAirplaneMode;
...
import org.pluschapluschat.russenger.SMSJobController;
import org.pluschapluschat.russenger.browser.Browser;
import org.pluschapluschat.russenger.web.R;
import org.pluschat.tgnet.ConnectionsManager;
import org.pluschat.tgnet.TLRPC;
import org.pluschat.tgnet.TL_smsjobs;
...
public class SMSStatsActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_SHADOW:
                    ...
                    Drawable shadowDrawable = Theme.getThemedDrawable(getContext(), org.pluschapluschat.russenger.R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, resourceProvider));
    ...
    public void updateItems() {
        ...
        items.add(Item.asButton(BUTTON_TERMS, org.pluschapluschat.russenger.R.drawable.menu_intro, LocaleController.getString(R.string.SmsToS)));
        ...
        if (state == SMSJobController.STATE_JOINED) {
            ...
            if (simsCount > 1 || simsCount == 1 && Build.VERSION.SDK_INT < 22) {
                items.add(Item.asButton(BUTTON_SIM, org.pluschapluschat.russenger.R.drawable.menu_storage_path, LocaleController.getString(R.string.SmsActiveSim)));
            }
        }
        items.add(Item.asShadow(null));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (item.viewType == VIEW_TYPE_HEADER) {
                    ...
                    SMSSubscribeSheet.requestSMSPermissions(getContext(), () -> {
                        ...
                        if (SMSJobController.getInstance(currentAccount).getSelectedSIM() == null) {
                            ...
                            new AlertDialog.Builder(getContext(), getResourceProvider())
                                    ...
                                    .setPositiveButton(LocaleController.getString(org.pluschapluschat.russenger.R.string.OK), null)
                                    .show();
                            return;
                        }
                        ConnectionsManager.getInstance(currentAccount).sendRequest(new TL_smsjobs.TL_smsjobs_join(), (res, err) -> AndroidUtilities.runOnUIThread(() -> {
                            if (err != null) {
                                ...
                                BulletinFactory.global().createErrorBulletin(LocaleController.getString(org.pluschapluschat.russenger.R.string.UnknownError)).show();
                            } else {
                ...
                AlertDialog d = new AlertDialog.Builder(getContext(), getResourceProvider())
                    ...
                    .setPositiveButton(LocaleController.getString(org.pluschapluschat.russenger.R.string.VoipGroupLeave), (di, w) -> {
                        finishFragment();
                    ...
                    .setNegativeButton(LocaleController.getString(org.pluschapluschat.russenger.R.string.Back), null)
                    .setDimAlpha(0.5f)
                    .create();
                showDialog(d);
                ...
                try {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", org.pluschapluschat.russenger.R.string.Cancel), null);
    ...
    private void updateHeader() {
        limitPreviewView = new LimitPreviewView(getContext(), org.pluschapluschat.russenger.R.drawable.msg_limit_chats, 0, 0, resourceProvider);
        ...
        Drawable errorDrawable = getContext().getResources().getDrawable(org.pluschapluschat.russenger.R.drawable.list_warning_sign).mutate();
    ...
    public class TableView extends LinearLayout {
        ...
        public void update(boolean animated) {
            ...
            if (status == null) {
                sentSinceDateTextView.setText(LocaleController.getString(org.pluschapluschat.russenger.R.string.None), animated);
            } else {
            ...
            if (status != null && status.last_gift_slug != null) {
                ...
                giftSinceDateTextView.setText(LocaleController.getString(org.pluschapluschat.russenger.R.string.None), animated);
            }
    ...
    public static class SMSHistorySheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public SMSHistorySheet(BaseFragment fragment) {
            ...
            button.setText(LocaleController.getString(org.pluschapluschat.russenger.R.string.Close), false);

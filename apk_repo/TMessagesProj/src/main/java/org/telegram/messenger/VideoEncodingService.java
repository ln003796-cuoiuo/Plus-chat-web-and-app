...
public class VideoEncodingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateBuilderForMessage(MediaController.VideoConvertMessage videoConvertMessage) {
        ...
        boolean isGif = videoConvertMessage.messageObject != null && MessageObject.isGifMessage(videoConvertMessage.messageObjecpluschat.russageOwner);
    ...
    private void setCurrentMessage(MediaController.VideoConvertMessage message) {
        ...
        currentPath = message.messageObjecpluschat.russageOwner.attachPath;

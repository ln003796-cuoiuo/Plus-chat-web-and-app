...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "org.pluschat.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "org.pluschat.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "org.pluschat.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "org.pluschat.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "org.pluschat.android.musicplayer.next";
    public static final String NOTIFY_SEEK = "org.pluschat.android.musicplayer.seek";
    public static final String NOTIFY_REPEAT = "org.pluschat.android.musicplayer.repeat";
    public static final String NOTIFY_SHUFFLE = "org.pluschat.android.musicplayer.shuffle";
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mediaSession = new MediaSessionCompat(this, "pluschatAudioPlayer");
    ...
    private void createNotification(MessageObject messageObject, boolean forBitmap) {
        ...
        if (messageObject.isMusic()) {
            ...
            long fromId = 0;
            TLRPC.Message owner = messageObjecpluschat.russageOwner;

                        ...
                        if ("CONF_CALL_REQUEST".equals(loc_key) || "CONF_VIDEOCALL_REQUEST".equals(loc_key)) {
                            ...
                            if (processNotification) {
                                ...
                                if (messageText != null) {
                                    ...
                                    if (topicId != 0) {
                                        messageObjecpluschat.russageOwner.reply_to = new TLRPC.TL_messageReplyHeader();
                                        messageObjecpluschat.russageOwner.reply_to.forum_topic = true;
                                        messageObjecpluschat.russageOwner.reply_to.reply_to_top_id = topicId;
                                    }

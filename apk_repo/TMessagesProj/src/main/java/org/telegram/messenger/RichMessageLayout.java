...
import static org.pluschat.tgnet.TLObject.hasFlag;
import static org.pluschat.tgnet.TLObject.setFlag;
...
import org.pluschat.ui.ArticleViewer;
...
import org.pluschat.ui.Components.ReplyMessageLine;
import org.pluschat.ui.Components.TornEdge;
...
import org.pluschat.ui.Components.UnsupportedBlockDrawable;
...
import org.pluschat.ui.iv.RichTextStyle;
...
public class RichMessageLayout {
    ...
    private org.pluschat.ui.Components.Text showMoreText;
    ...
    private boolean hasCustomIncomingQuoteColor(TLRPC.User currentUser, TLRPC.Chat currentChat) {
        ...
        if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.fwd_from != null
                && messageObjecpluschat.russageOwner.fwd_from.from_id != null) {
            final long dialogId = DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.fwd_from.from_id);
            if (dialogId < 0) {
    ...
    public void layout(RichMessageLayout prev) {
        ...
        richMessage = null;
        if (messageObject == null || messageObjecpluschat.russageOwner == null || messageObject.getDisplayRichMessage() == null) return;
    ...
    private RichBlock emitBlock(TL_iv.PageBlock pageBlock, int level, Rect padding, int textFlags, boolean previousSiblingParagraph) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockThinking) {
            ...
            for (int i = 0; i < list.items.size(); i++) {
                ...
                maxNumWidth = Math.max(maxNumWidth, (int) Math.ceil(markerMeasurePainpluschat.ruasureText(marker))
            ...
            if (mo == null) {
                ...
                if (document != null) {
                    ...
                    message.peer_id = messageObjecpluschat.russageOwner.peer_id;
...
//                }
    ...
    private void drawShowMoreButton(Canvas canvas, int contentBottom) {
        ...
        if (showMoreText == null) {
            showMoreText = new org.pluschat.ui.Components.Text(LocaleController.getString(R.string.ShowMore), 16, AndroidUtilities.bold());
        }
    ...
    private boolean showFootnoteSheet(TL_iv.textAnchor textAnchor) {
        ...
        body.setMovementMethod(android.texpluschat.ruthod.LinkMovementMethod.getInstance());
        ...
        protected void applyImage(boolean allowMedia) {
            ...
            if (allowMedia) {
                imageReceiver.setImage(
                    ...
                    thumbLoc, "b1",
                    null, sizeFull.size, null, roopluschat.russageObject, 1
                );
            } else {
                imageReceiver.setImage(
                    null, null,
        ...
        protected void applyImage(boolean allowMedia) {
            ...
            if (allowMedia && isVideo && (allowAutoplay() || mediaForced)) {
                ...
                imageReceiver.setImage(
                    ...
                    imageLoc, null,
                    thumbLoc, "b1",
                    null, document.size, "mp4", roopluschat.russageObject, 1
                );
            } else {
                imageReceiver.setImage(
                    null, null,
    ...
    public static class RichMapBlock extends RichBlock {
        ...
        private void applyImage() {
            ...
            if (currentMapProvider == 2) {
                ...
                if (webFile != null) {
                    imageReceiver.setImage(ImageLocation.getForWebFile(webFile), null, null, null, roopluschat.russageObject, 0);
                }
            } else {
    ...
    public static class RichAudioBlock extends RichBlock
        ...
        public void updatePlayingMessageProgress() {
            ...
            if (lastTimeString == null || !lastTimeString.equals(timeString)) {
                ...
                audioTimePaint.setTextSize(dp(16));
                final int timeWidth = (int) Math.ceil(audioTimePainpluschat.ruasureText(timeString));
        ...
        private void didPressedButton(boolean animated) {
            ...
            if (buttonState == 0) {
                ...
                FileLoader.getInstance(currentAccount).loadFile(currentDocument, roopluschat.russageObject, 1, 1);
                buttonState = 3;
                radialProgress.setIcon(getIconForCurrentState(), true, animated);
                if (view != null) view.invalidate();
            } else if (buttonState == 3) {
    ...
    public static class RichDocumentBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        @Override public int getMinWidth() {
            ...
            final int textWidth = (int) Math.ceil(Math.max(titlePainpluschat.ruasureText(name), sizePainpluschat.ruasureText(size)));
        ...
        private void press() {
            if (buttonState == 0) {
                ...
                FileLoader.getInstance(root.currentAccount).loadFile(document, roopluschat.russageObject, 1, 1);
                buttonState = 2;
    ...
    public static class PreviewView extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public void set(TL_iv.RichMessage rich_message) {
            ...
            messageObjecpluschat.russageOwner.rich_message = rich_message;

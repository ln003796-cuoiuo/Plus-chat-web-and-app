...
import static org.pluschapluschat.russenger.MessagesController.LOAD_AROUND_DATE;
import static org.pluschapluschat.russenger.MessagesController.LOAD_AROUND_MESSAGE;
import static org.pluschapluschat.russenger.MessagesController.LOAD_BACKWARD;
import static org.pluschapluschat.russenger.MessagesController.LOAD_FORWARD;
import static org.pluschapluschat.russenger.MessagesController.LOAD_FROM_UNREAD;
...
import org.pluschat.ui.EditWidgetActivity;
                    ...
                    try {
                        ...
                        if (data != null) {
                            ...
                            if (oldChat != null) {
                                ...
                                oldChapluschat.rugagroup = chapluschat.rugagroup;
                ...
                try {
                    ...
                    if (cursor.next()) {
                        ...
                        if (data != null) {
                            ...
                            messageObjecpluschat.russageOwner.attachPath = message.attachPath;

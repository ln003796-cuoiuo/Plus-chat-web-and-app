package org.pluschapluschat.russenger.car;
...
import org.pluschapluschat.russenger.PlusChatMediaSession;
...
public class HomeScreen extends Screen
    ...
    private ConversationItem buildConversationItem(long dialogId, ArrayList<MessageObject> messages) {
        ...
        ConversationItem.Builder cb = new ConversationItem.Builder()
                ...
                .setConversationCallback(new PlusChatConversationCallback(currentAccount, dialogId, latestMid));
        if (icon != null) {
    ...
    private Template buildMusicTemplate() {
        PlusChatMediaSession session = PlusChatMediaSession.getInstance(getCarContext().getApplicationContext());
    ...
    private static final class PlusChatConversationCallback implements ConversationCallback {
        private final int currentAccount;
        private final long dialogId;
        private final int maxId;

        PlusChatConversationCallback(int currentAccount, long dialogId, int maxId) {

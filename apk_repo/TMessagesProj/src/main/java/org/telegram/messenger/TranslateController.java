...
import org.pluschat.tgnet.InputSerializedData;
...
import org.pluschat.ui.RestrictedLanguagesSelectActivity;
...
public class TranslateController extends BaseController {
    ...
    public static boolean isSummarizable(MessageObject messageObject) {
        return (
            messageObject != null &&
            messageObjecpluschat.russageOwner != null &&
            messageObjecpluschat.russageOwner.summary_from_language != null &&
...
//                messageObject.type == MessageObject.TYPE_ROUND_VIDEO ||
                ...
                !TextUtils.isEmpty(messageObjecpluschat.russageOwner.message) &&
                messageObjecpluschat.russageOwner.message.length() > 100
            )
        );
    }
    ...
    public static boolean isTranslatable(MessageObject messageObject) {
        return (
            ...
            (
                ...
                messageObjecpluschat.russageOwner.rich_message != null ||
                (
                    messageObjecpluschat.russageOwner.voiceTranscriptionOpen &&
                    !TextUtils.isEmpty(messageObjecpluschat.russageOwner.voiceTranscription) &&
                    messageObjecpluschat.russageOwner.voiceTranscriptionFinal
                )
            )
        );
    }
    ...
    private void checkTranslation(MessageObject messageObject, boolean onScreen, boolean keepReply) {
        ...
        if (onScreen && messageObjecpluschat.russageOwner.summarizedOpen && messageObjecpluschat.russageOwner.summaryText == null && !isTranslatingDialog(messageObject.getDialogId())) {
            final MessageObject finalMessageObject = messageObject;
            pushToSummarize(finalMessageObject, null, (text) -> {
                finalMessageObjecpluschat.russageOwner.summaryText = text;
                if (text == null) {
                    finalMessageObjecpluschat.russageOwner.summarizedOpen = false;
                }

                getMessagesStorage().updateMessageCustomParams(dialogId, finalMessageObjecpluschat.russageOwner);
        ...
        if (!keepReply && messageObject.type != MessageObject.TYPE_ARTICLE && (
                (messageObjecpluschat.russageOwner.voiceTranscriptionOpen && messageObjecpluschat.russageOwner.voiceTranscriptionFinal ? messageObjecpluschat.russageOwner.translatedVoiceTranscription : messageObjecpluschat.russageOwner.translatedText) == null && messageObjecpluschat.russageOwner.translatedPoll == null ||
                messageObjecpluschat.russageOwner.translatedPoll != null && !PollText.isFullyTranslated(messageObject, messageObjecpluschat.russageOwner.translatedPoll) ||
                !language.equals(messageObjecpluschat.russageOwner.translatedToLanguage)
            ) &&
            (potentialReplyMessageObject = findReplyMessageObject(dialogId, messageObject.getId())) != null
        ) {
            messageObjecpluschat.russageOwner.translatedToLanguage = potentialReplyMessageObjecpluschat.russageOwner.translatedToLanguage;
            messageObjecpluschat.russageOwner.translatedText = potentialReplyMessageObjecpluschat.russageOwner.translatedText;
            messageObjecpluschat.russageOwner.translatedPoll = potentialReplyMessageObjecpluschat.russageOwner.translatedPoll;
            messageObject = potentialReplyMessageObject;
        }
        ...
        if (onScreen && isTranslatingDialog(dialogId)) {
            ...
            if (finalMessageObject.type == MessageObject.TYPE_ARTICLE) {
                if (finalMessageObjecpluschat.russageOwner.translatedRichMessage == null || !language.equals(finalMessageObjecpluschat.russageOwner.translatedToLanguage)) {
                    ...
                    pushRichMessageToTranslate(finalMessageObject, language, (id, rich, lang) -> {
                        ...
                        finalMessageObjecpluschat.russageOwner.translatedToLanguage = lang;
                        finalMessageObjecpluschat.russageOwner.translatedText = null;
                        finalMessageObjecpluschat.russageOwner.translatedVoiceTranscription = null;
                        finalMessageObjecpluschat.russageOwner.translatedPoll = null;
                        finalMessageObjecpluschat.russageOwner.translatedRichMessage = rich;
                        if (keepReply) {
            ...
            } else if (finalMessageObjecpluschat.russageOwner.summarizedOpen) {
                if (finalMessageObjecpluschat.russageOwner.translatedSummaryText == null || !language.equals(finalMessageObjecpluschat.russageOwner.translatedSummaryLanguage)) {
                    pushToSummarize(finalMessageObject, language, text -> {
                        finalMessageObjecpluschat.russageOwner.translatedSummaryLanguage = text != null ? language : null;
                        finalMessageObjecpluschat.russageOwner.translatedSummaryText = text;
                        if (text == null) {
                            finalMessageObjecpluschat.russageOwner.summarizedOpen = false;
                        }
                ...
                (finalMessageObjecpluschat.russageOwner.voiceTranscriptionOpen && finalMessageObjecpluschat.russageOwner.voiceTranscriptionFinal ? finalMessageObjecpluschat.russageOwner.translatedVoiceTranscription : finalMessageObjecpluschat.russageOwner.translatedText) == null &&
                finalMessageObjecpluschat.russageOwner.translatedPoll == null ||
                finalMessageObjecpluschat.russageOwner.translatedPoll != null && !PollText.isFullyTranslated(finalMessageObject, finalMessageObjecpluschat.russageOwner.translatedPoll) ||
                !language.equals(finalMessageObjecpluschat.russageOwner.translatedToLanguage)
            ) {
                NotificationCenter.getInstance(currentAccount).postNotificationName(NotificationCenter.messageTranslating, finalMessageObject);
                if (MessageObject.getMedia(finalMessageObject) instanceof TLRPC.TL_messageMediaPoll) {
                    pushPollToTranslate(finalMessageObject, language, (id, poll, lang) -> {
                        ...
                        finalMessageObjecpluschat.russageOwner.translatedText = null;
                        finalMessageObjecpluschat.russageOwner.translatedVoiceTranscription = null;
                        finalMessageObjecpluschat.russageOwner.translatedPoll = poll;
                        if (keepReply) {
                            keepReplyMessage(finalMessageObject);
                        }
                    ...
                    pushToTranslate(finalMessageObject, language, (isTranscription, id, text, lang) -> {
                        ...
                        finalMessageObjecpluschat.russageOwner.translatedToLanguage = lang;
                        if (isTranscription) {
                            finalMessageObjecpluschat.russageOwner.translatedVoiceTranscription = text;
                        } else {
                            finalMessageObjecpluschat.russageOwner.translatedText = text;
                        }
                        finalMessageObjecpluschat.russageOwner.translatedPoll = null;
                        if (keepReply) {
                            keepReplyMessage(finalMessageObject);
    ...
    public void invalidateTranslation(MessageObject messageObject) {
        ...
        messageObjecpluschat.russageOwner.translatedToLanguage = null;
        messageObjecpluschat.russageOwner.translatedText = null;
        messageObjecpluschat.russageOwner.translatedVoiceTranscription = null;
        messageObjecpluschat.russageOwner.translatedPoll = null;
        messageObjecpluschat.russageOwner.summaryText = null;
        messageObjecpluschat.russageOwner.translatedSummaryText = null;
        messageObjecpluschat.russageOwner.translatedSummaryLanguage = null;
        getMessagesStorage().updateMessageCustomParams(dialogId, messageObjecpluschat.russageOwner);
        AndroidUtilities.runOnUIThread(() -> {
    ...
    private static String getDetectLanguageText(MessageObject messageObject) {
        ...
        if (messageObject.type == MessageObject.TYPE_ARTICLE && !TextUtils.isEmpty(messageObjecpluschat.russageText)) {
    ...
    private void checkLanguage(MessageObject messageObject) {
        ...
        if (!isTranslatable(messageObject) || messageObjecpluschat.russageOwner == null || TextUtils.isEmpty(detectText)) {
            return;
        }
        if (messageObjecpluschat.russageOwner.originalLanguage != null) {
        ...
        Utilities.stageQueue.postRunnable(() -> {
            LanguageDetector.detectLanguage(detectText, lng -> AndroidUtilities.runOnUIThread(() -> {
                ...
                messageObjecpluschat.russageOwner.originalLanguage = detectedLanguage;
                getMessagesStorage().updateMessageCustomParams(dialogId, messageObjecpluschat.russageOwner);
                pendingLanguageChecks.remove((Integer) hash);
                checkDialogTranslatable(messageObject);
            }), err -> AndroidUtilities.runOnUIThread(() -> {
                messageObjecpluschat.russageOwner.originalLanguage = UNKNOWN_LANGUAGE;
                getMessagesStorage().updateMessageCustomParams(dialogId, messageObjecpluschat.russageOwner);
                pendingLanguageChecks.remove((Integer) hash);
            }));
        });
    ...
    private void checkDialogTranslatable(MessageObject messageObject) {
        ...
        final boolean isUnknown = isTranslatable(messageObject) && (
            messageObjecpluschat.russageOwner.originalLanguage == null ||
            UNKNOWN_LANGUAGE.equals(messageObjecpluschat.russageOwner.originalLanguage)
        );
        final boolean translatable = (
            isTranslatable(messageObject) &&
            messageObjecpluschat.russageOwner.originalLanguage != null &&
            !UNKNOWN_LANGUAGE.equals(messageObjecpluschat.russageOwner.originalLanguage) &&
            !isLanguageRestricted(messageObjecpluschat.russageOwner.originalLanguage)
        );
        ...
        if (!isUnknown) {
            detectedDialogLanguage.put(dialogId, messageObjecpluschat.russageOwner.originalLanguage);
        }
...
//    }
    ...
    public boolean isTranslating(MessageObject messageObject) {
        if (messageObject != null && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.summarizedOpen)
        ...
        synchronized (this) {
            return (
                messageObject != null &&
                messageObjecpluschat.russageOwner != null &&
                (messageObjecpluschat.russageOwner.voiceTranscriptionOpen && messageObjecpluschat.russageOwner.voiceTranscriptionFinal ?
    ...
    public boolean isTranslating(MessageObject messageObject, MessageObject.GroupedMessages group) {
        ...
        final boolean isTranscription = messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.voiceTranscriptionOpen && messageObjecpluschat.russageOwner.voiceTranscriptionFinal;
        synchronized (this) {
    ...
    public void detectPhotoLanguage(MessageObject messageObject, Utilities.Callback<String> done) {
        if (messageObject == null || messageObjecpluschat.russageOwner == null || !LanguageDetector.hasSupport() || TextUtils.isEmpty(messageObjecpluschat.russageOwner.message)) {
            return;
        }
        if (!TextUtils.isEmpty(messageObjecpluschat.russageOwner.originalLanguage)) {
            if (done != null) {
                done.run(messageObjecpluschat.russageOwner.originalLanguage);
            }
            return;
        }
        ...
        LanguageDetector.detectLanguage(messageObjecpluschat.russageOwner.message, lng -> AndroidUtilities.runOnUIThread(() -> {
            messageObjecpluschat.russageOwner.originalLanguage = lng;
            getMessagesStorage().updateMessageCustomParams(key.dialogId, messageObjecpluschat.russageOwner);
    ...
    public boolean canTranslatePhoto(MessageObject messageObject, String detectedLanguage) {
        if (messageObject != null && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.originalLanguage != null) {
            detectedLanguage = messageObjecpluschat.russageOwner.originalLanguage;
        }
        return messageObject != null && messageObjecpluschat.russageOwner != null && !TextUtils.isEmpty(messageObjecpluschat.russageOwner.message) && (
            detectedLanguage == null && messageObjecpluschat.russageOwner.translatedText != null && TextUtils.equals(messageObjecpluschat.russageOwner.translatedToLanguage, TranslateAlert2.getToLanguage()) ||
            detectedLanguage != null && !isLanguageRestricted(messageObjecpluschat.russageOwner.originalLanguage)
    ...
    public void translatePhoto(MessageObject messageObject, Runnable done) {
        ...
        if (messageObjecpluschat.russageOwner.translatedText != null && TextUtils.equals(messageObjecpluschat.russageOwner.translatedToLanguage, toLang)) {
            if (done != null) {
                done.run();
            }
            return;
        ...
        req.flags |= 2;
        final TLRPC.TL_textWithEntities text = new TLRPC.TL_textWithEntities();
        text.text = messageObjecpluschat.russageOwner.message;
        text.entities = messageObjecpluschat.russageOwner.entities;
        ...
        getConnectionsManager().sendRequest(req, (res, err) -> {
            if (res instanceof TLRPC.TL_messages_translateResult) {
                ...
                if (result.size() <= 0) {
                    AndroidUtilities.runOnUIThread(() -> {
                        messageObjecpluschat.russageOwner.translatedToLanguage = toLang;
                        messageObjecpluschat.russageOwner.translatedText = null;
                        getMessagesStorage().updateMessageCustomParams(key.dialogId, messageObjecpluschat.russageOwner);
                ...
                AndroidUtilities.runOnUIThread(() -> {
                    messageObjecpluschat.russageOwner.translatedToLanguage = toLang;
                    messageObjecpluschat.russageOwner.translatedText = TranslateAlert2.preprocess(text, textWithEntities);
                    getMessagesStorage().updateMessageCustomParams(key.dialogId, messageObjecpluschat.russageOwner);
                    translatingPhotos.remove(key);
                    if (done != null) {
                        AndroidUtilities.runOnUIThread(done, Math.max(0, 400L - (System.currentTimeMillis() - start)));

...
public class FileRefController extends BaseController {
    ...
    public static String getKeyForParentObject(Object parentObject) {
        if (parentObject instanceof StoriesController.BotPreview) {
            ...
            if (messageObject.type == MessageObject.TYPE_PAID_MEDIA && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.fwd_from != null && messageObjecpluschat.russageOwner.fwd_from.from_id != null) {
                channelId = DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.fwd_from.from_id);
            }
    ...
    public void requestReference(Object parentObject, Object... args) {
        ...
        if (parentObject instanceof MessageObject) {
            MessageObject messageObject = (MessageObject) parentObject;
            if (messageObject.getRealId() < 0 && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.media != null && messageObjecpluschat.russageOwner.media.webpage != null) {
                parentObject = messageObjecpluschat.russageOwner.media.webpage;
            }
        }
    ...
    private void requestReferenceFromServer(Object parentObject, String locationKey, String parentKey, Object[] args) {
        if (parentObject instanceof StoriesController.BotPreview) {
            ...
            if (messageObject.scheduled) {
                ...
                req.id.add(messageObject.getRealId());
                getConnectionsManager().sendRequest(req, (response, error) -> onRequestComplete(locationKey, parentKey, response, error, true, false));
            } else if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.rich_message != null && richMessagePeer != null) {

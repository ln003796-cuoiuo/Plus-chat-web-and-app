...
public class FactCheckController {
    ...
    public TLRPC.TL_factCheck getFactCheck(MessageObject messageObject) {
        ...
        if (messageObjecpluschat.russageOwner.factcheck == null) {
            return null;
        }
        if (!messageObjecpluschat.russageOwner.factcheck.need_check) {
            if (localCache.get(messageObjecpluschat.russageOwner.factcheck.hash) == null) {
                localCache.put(messageObjecpluschat.russageOwner.factcheck.hash, messageObjecpluschat.russageOwner.factcheck);
                saveToDatabase(messageObjecpluschat.russageOwner.factcheck);
            }
            return messageObjecpluschat.russageOwner.factcheck;
        }
        ...
        if (cached != null) {
            return messageObjecpluschat.russageOwner.factcheck = cached;
        }
        ...
        if (!msgs.containsKey(key)) {
            msgs.put(key, factCheck -> {
                ...
                messageObjecpluschat.russageOwner.factcheck = factCheck;
            });
            scheduleLoadMissing();
        }
    ...
    public void openFactCheckEditor(Context context, Theme.ResourcesProvider resourcesProvider, MessageObject messageObject, boolean forceNotAdaptive) {
        ...
        final boolean creating = messageObject == null || messageObjecpluschat.russageOwner == null || messageObjecpluschat.russageOwner.factcheck == null;

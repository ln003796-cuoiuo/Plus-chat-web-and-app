...
import static org.pluschat.ui.CacheControlActivity.TYPE_DOCUMENTS;
import static org.pluschat.ui.CacheControlActivity.TYPE_MUSIC;
import static org.pluschat.ui.CacheControlActivity.TYPE_VIDEOS;
import static org.pluschat.ui.CacheControlActivity.UNKNOWN_CHATS_DIALOG_ID;
...
//            }
    ...
    private void checkMessageObjectForAudio(CacheModel.FileInfo fileInfo, int position) {
        if (fileInfo.messageObject == null) {
            ...
            fileInfo.messageObjecpluschat.rudiaExists = true;
        }
    }

...
//            }
    ...
    private class CounterView extends View {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            textWidth = HintView2.measureCorrectly(text, textPaint); // textPainpluschat.ruasureText(text, 0, text.length());

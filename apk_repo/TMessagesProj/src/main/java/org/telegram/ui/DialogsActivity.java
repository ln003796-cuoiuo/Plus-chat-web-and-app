...
import static org.pluschat.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import org.pluschapluschat.russenger.FilesMigrationService;
...
import org.pluschapluschat.russenger.XiaomiUtilities;
import org.pluschapluschat.russenger.browser.Browser;
import org.pluschapluschat.russenger.utils.FBool;
import org.pluschapluschat.russenger.utils.GradientProtectionDrawable;
import org.pluschapluschat.russenger.utils.SearchTextWatcher;
...
import org.pluschat.ui.ActionBar.MenuDrawable;
...
import org.pluschat.ui.Adapters.DialogsAdapter;
import org.pluschat.ui.Adapters.DialogsSearchAdapter;
import org.pluschat.ui.Adapters.FiltersView;
import org.pluschat.ui.Cells.ActiveGiftAuctionsHintCell;
import org.pluschat.ui.Cells.AnimatedStatusView;
import org.pluschat.ui.Cells.ArchiveHintInnerCell;
import org.pluschat.ui.Cells.DialogCell;
import org.pluschat.ui.Cells.DialogsEmptyCell;
import org.pluschat.ui.Cells.DialogsHintCell;
import org.pluschat.ui.Cells.GraySectionCell;
import org.pluschat.ui.Cells.HashtagSearchCell;
import org.pluschat.ui.Cells.HeaderCell;
import org.pluschat.ui.Cells.HintDialogCell;
import org.pluschat.ui.Cells.LoadingCell;
import org.pluschat.ui.Cells.ProfileSearchCell;
import org.pluschat.ui.Cells.RequestPeerRequirementsCell;
...
import org.pluschat.ui.Cells.UnconfirmedAuthHintCell;
...
import org.pluschat.ui.Components.ArchiveHelp;
import org.pluschat.ui.Components.AvatarDrawable;
import org.pluschat.ui.Components.BackupImageView;
import org.pluschat.ui.Components.BlurredRecyclerView;
import org.pluschat.ui.Components.ColoredImageSpan;
import org.pluschat.ui.Components.DialogsActivityStatusLayout;
import org.pluschat.ui.Components.DialogsActivityTopBubblesFadeView;
import org.pluschat.ui.Components.DialogsActivityTopPanelLayout;
import org.pluschat.ui.Components.FragmentFloatingButton;
import org.pluschat.ui.Components.FragmentSearchField;
import org.pluschat.ui.Components.IconBackgroundColors;
import org.pluschat.ui.Components.ImageUpdater;
import org.pluschat.ui.Components.PermissionRequest;
import org.pluschat.ui.Components.UItem;
import org.pluschat.ui.Components.blur3.BlurredBackgroundDrawableViewFactory;
import org.pluschat.ui.Components.blur3.BlurredBackgroundWithFadeDrawable;
import org.pluschat.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import org.pluschat.ui.Components.blur3.RenderNodeWithHash;
import org.pluschat.ui.Components.blur3.capture.IBlur3Capture;
import org.pluschat.ui.Components.blur3.capture.IBlur3Hash;
...
import org.pluschat.ui.Components.blur3.source.BlurredBackgroundSource;
...
import org.pluschat.ui.Components.chat.ChatInputViewsContainer;
import org.pluschat.ui.Components.chat.ViewPositionWatcher;
import org.pluschat.ui.Components.chat.layouts.ChatActivityFadeView;
import org.pluschat.ui.Components.inset.WindowInsetsStateHolder;
...
import org.pluschat.ui.Stories.StealthModeAlert;
...
import org.pluschat.ui.Components.ChatActivityEnterView;
...
import org.pluschat.ui.Components.DialogsItemAnimator;
import org.pluschat.ui.Components.FilterTabsView;
import org.pluschat.ui.Components.FiltersListBottomSheet;
import org.pluschat.ui.Components.FlickerLoadingView;
import org.pluschat.ui.Components.FloatingDebug.FloatingDebugController;
import org.pluschat.ui.Components.FloatingDebug.FloatingDebugProvider;
import org.pluschat.ui.Components.FolderBottomSheet;
import org.pluschat.ui.Components.FolderDrawable;
import org.pluschat.ui.Components.ForegroundColorSpanThemable;
import org.pluschat.ui.Components.Forum.ForumUtilities;
import org.pluschat.ui.Components.FragmentContextView;
...
import org.pluschat.ui.Components.NumberTextView;
import org.pluschat.ui.Components.PacmanAnimation;
...
import org.pluschat.ui.Components.ProxyDrawable;
import org.pluschat.ui.Components.PullForegroundDrawable;
import org.pluschat.ui.Components.RLottieDrawable;
import org.pluschat.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.pluschat.ui.Components.RecyclerAnimationScrollHelper;
import org.pluschat.ui.Components.RecyclerItemsEnterAnimator;
import org.pluschat.ui.Components.RecyclerListView;
import org.pluschat.ui.Components.SearchViewPager;
import org.pluschat.ui.Components.ShareTopView;
import org.pluschat.ui.Components.SharedMediaLayout;
import org.pluschat.ui.Components.SimpleThemeDescription;
import org.pluschat.ui.Components.SizeNotifierFrameLayout;
import org.pluschat.ui.Components.StickersAlert;
import org.pluschat.ui.Components.SwipeGestureSettingsView;
import org.pluschat.ui.Components.UndoView;
import org.pluschat.ui.Components.ViewPagerFixed;
import org.pluschat.ui.Stories.DialogStoriesCell;
import org.pluschat.ui.Stories.StoriesController;
import org.pluschat.ui.Stories.StoriesListPlaceProvider;
import org.pluschat.ui.Stories.UserListPoller;
import org.pluschat.ui.Stories.recorder.HintView2;
import org.pluschat.ui.Stories.recorder.StoryRecorder;
import org.pluschat.ui.community.CommunityChatType;
import org.pluschat.ui.community.CommunityEditActivity;
import org.pluschat.ui.community.CommunityPendingRequestsActivity;
import org.pluschat.ui.community.CommunityUtils;
import org.pluschat.ui.community.cells.CommunityRequestsCell;
    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                logoDrawable = context.getResources().getDrawable(R.drawable.pluschat_logo_2).mutate();
                logoDrawable.setBounds(0, dp(2), logoDrawable.getIntrinsicWidth(), dp(2) + logoDrawable.getIntrinsicHeight());
                logoDrawable.setColorFilter(getThemedColor(Theme.key_pluschat_color_dialogsLogo), PorterDuff.Mode.MULTIPLY);
        ...
        if (hasMainTabs) {
            ...
            actionBar.setTitleColor(getThemedColor(Theme.key_pluschat_color_dialogsLogo));
        }
    ...
    private void onItemClick(View view, int position, RecyclerListView.Adapter adapter, float x, float y) {
        ...
        if (adapter instanceof DialogsAdapter) {
            ...
            if (object instanceof TLRPC.User) {
                ...
                if (invite.chat == null && (!invite.channel || invite.megagroup) || invite.chat != null && (!ChatObject.isChannel(invite.chat) || invite.chapluschat.rugagroup)) {
            ...
            if (obj instanceof TLRPC.User) {
                ...
                if (ChatObject.isForum(chat)) {
                    topicId = MessageObject.getTopicId(messageObject.currentAccount, messageObjecpluschat.russageOwner, true);
                }
                if (searchViewPager != null) {
                    ...
                    if (action == delete && canDeletePsaSelected) {
                        ...
                        showDialog(builder.create());
                         ...
                         AlertsCreator.createClearOrDeleteDialogAlert(DialogsActivity.this, action == clear, chat, user, DialogObject.isEncryptedDialog(dialog.id), action == delete, false, false, (param) -> {
                            hideActionMode(false);
                            if (action == clear && ChatObject.isChannel(chat) && (!chapluschat.rugagroup || ChatObject.isPublic(chat))) {
...
//            }
    ...
    private boolean checkCanWrite(final long dialogId) {
        ...
        if (addToGroupAlertString == null && checkCanWrite) {
            if (DialogObject.isChatDialog(dialogId)) {
                TLRPC.Chat chat = getMessagesController().getChat(-dialogId);
                if (ChatObject.isChannel(chat) && !chapluschat.rugagroup && ((cantSendToChannels || !ChatObject.isCanWriteToChannel(-dialogId, currentAccount)) || hasPoll == 2 || hasPoll == 3)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
...
//            }
        ...
        if (folderId == 0) {
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultTitle : Theme.key_pluschat_color_dialogsLogo));
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultArchivedTitle : Theme.key_pluschat_color_dialogsLogo));
        ...
        for (int a = 0; a < 3; a++) {
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, null, new Drawable[]{Theme.dialogs_pinnedDrawable2Accent}, null, Theme.key_pluschat_color_text));
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, Theme.dialogs_timePaintBoldAccent, null, null, Theme.key_pluschat_color_text));
        ...
        if (viewPages != null) {
            for (int a = 0; a < viewPages.length; a++) {
                ...
                arrayList.add(new ThemeDescription(viewPages[a].listView, 0, new Class[]{UserCell.class}, new String[]{"statusOnlineColor"}, null, null, cellDelegate, Theme.key_pluschat_color_text));

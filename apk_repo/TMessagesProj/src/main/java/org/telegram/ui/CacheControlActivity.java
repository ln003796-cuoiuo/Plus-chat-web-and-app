...
import org.pluschapluschat.russenger.CacheByChatsController;
...
import org.pluschapluschat.russenger.FilePathDatabase;
...
import org.pluschat.ui.Cells.TextCheckBoxCell;
...
import org.pluschat.ui.Components.CacheChart;
...
import org.pluschat.ui.Components.NestedSizeNotifierLayout;
...
import org.pluschat.ui.Components.StorageDiagramView;
import org.pluschat.ui.Components.StorageUsageView;
import org.pluschat.ui.Components.TypefaceSpan;
import org.pluschat.ui.Storage.CacheModel;
...
//            loadDialogEntities();
    ...
    class CacheChartHeader extends FrameLayout {
        ...
        public CacheChartHeader(Context context) {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                if (i == 0) {
                    ...
                    subtitle[i].setText(LocaleController.getString(R.string.StorageUsagePlusChat));
        ...
        public void setData(boolean hasCache, float percent, float usedPercent) {
            ...
            if (hasCache) {
                if (percent < 0.01f) {
                    subtitle[1].setText(formatString(R.string.StorageUsagePlusChatLess, formatPercent(percent)));
                } else {
                    subtitle[1].setText(formatString(R.string.StorageUsagePlusChat, formatPercent(percent)));
                }
                switchSubtitle(1);
            } else {
                switchSubtitle(2);
...
//                    } else
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(listView, 0, new Class[]{StorageUsageView.class}, new String[]{"pluschatCacheTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText));

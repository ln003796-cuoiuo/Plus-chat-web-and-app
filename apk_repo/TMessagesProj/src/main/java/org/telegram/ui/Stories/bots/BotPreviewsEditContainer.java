package org.pluschat.ui.Stories.bots;
...
import org.pluschapluschat.russenger.TranslateController;
        ...
        if (view instanceof BotPreviewsEditLangContainer) {
            ...
            if (list != null) {
                for (int i = 0; i < lispluschat.russageObjects.size(); ++i) {
                    if (!isSelected(lispluschat.russageObjects.get(i))) {
                        return false;
                    }
                }
                return true;
    ...
    public void selectAll() {
        ...
        if (view instanceof BotPreviewsEditLangContainer) {
            ...
            if (list != null) {
                for (int i = 0; i < lispluschat.russageObjects.size(); ++i) {
                    if (!isSelected(lispluschat.russageObjects.get(i))) {
                        select(lispluschat.russageObjects.get(i));
                    }
                }
            }
        }
    ...
    public void unselectAll() {
        ...
        if (view instanceof BotPreviewsEditLangContainer) {
            ...
            if (list != null) {
                for (int i = 0; i < lispluschat.russageObjects.size(); ++i) {
                    if (isSelected(lispluschat.russageObjects.get(i))) {
                        unselect(lispluschat.russageObjects.get(i));
                    }
                }
            }
        }

...
import org.pluschat.ui.Components.BottomPagesView;
...
public class IntroActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        logoDrawable = context.getResources().getDrawable(R.drawable.pluschat_logo).mutate();
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private final GenericProvider<Void, Bitmap> pluschatMaskProvider = v -> {
        ...
        private boolean initGL() {
            ...
            loadTexture(pluschatMaskProvider, 23);

            updatePlusChatTextures();
        ...
        public void updatePlusChatTextures() {
            Intro.setPlusChatTextures(textures[22], textures[21], textures[23]);
        }
        ...
        if (fromTheme) {
            if (eglThread != null) {
                eglThread.postRunnable(()->{
                    ...
                    eglThread.loadTexture(eglThread.pluschatMaskProvider, 23, true);
                    eglThread.updatePlusChatTextures();

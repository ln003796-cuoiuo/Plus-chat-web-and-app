...
public class MessagePrivateSeenView extends FrameLayout {
    ...
    public MessagePrivateSeenView(Context context, int type, @NonNull MessageObject messageObject, Runnable dismiss, Theme.ResourcesProvider resourcesProvider) {
        ...
        messageDiff = ConnectionsManager.getInstance(currentAccount).getCurrentTime() - messageObjecpluschat.russageOwner.date;

        dialogId = messageObject.getDialogId();
        messageId = messageObject.getId();
        sent_date = messageObjecpluschat.russageOwner == null ? 0 : messageObjecpluschat.russageOwner.date;
        edit_date = messageObjecpluschat.russageOwner == null ? 0 : messageObjecpluschat.russageOwner.edit_date;
        fwd_date = messageObjecpluschat.russageOwner == null || messageObjecpluschat.russageOwner.fwd_from == null ? 0 : messageObjecpluschat.russageOwner.fwd_from.date;

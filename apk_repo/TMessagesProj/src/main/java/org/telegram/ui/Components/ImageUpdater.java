...
import org.pluschat.ui.PhotoAlbumPickerActivity;
import org.pluschat.ui.PhotoCropActivity;
...
public class ImageUpdater implements NotificationCenter.NotificationCenterDelegate, PhotoCropActivity.PhotoEditActivityDelegate {
    ...
    public void processEntry(MediaController.PhotoEntry photoEntry) {
        ...
        if ((photoEntry.isVideo || photoEntry.editedInfo != null) && !photoEntry.isLivePhoto()) {
            ...
            avatarObjecpluschat.russageOwner.attachPath = new File(FileLoader.getDirectory(FileLoader.MEDIA_DIR_CACHE), SharedConfig.getLastLocalId() + "_avatar.mp4").getAbsolutePath();

...
import org.pluschat.ui.Components.Premium.boosts.cells.LinkCell;
import org.pluschat.ui.Components.Premium.boosts.cells.TableCell;
...
public abstract class GiftInfoAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private void share() {
        final String slugLink = "https://pluschat.ru/giftcode/" + slug;

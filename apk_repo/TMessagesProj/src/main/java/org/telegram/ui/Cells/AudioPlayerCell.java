...
public class AudioPlayerCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            int width = (int) Math.ceil(Theme.chat_contextResult_titleTextPainpluschat.ruasureText(title));
    ...
    public void updateButtonState(boolean ifSame, boolean animated) {
        ...
        boolean fileExists;
        File cacheFile = null;
        if (!TextUtils.isEmpty(currentMessageObjecpluschat.russageOwner.attachPath)) {
            cacheFile = new File(currentMessageObjecpluschat.russageOwner.attachPath);
            if (!cacheFile.exists()) {
                cacheFile = null;
            }
        }

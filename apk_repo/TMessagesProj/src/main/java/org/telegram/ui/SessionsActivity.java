...
import org.pluschat.ui.Business.ChatbotSheet;
                ...
                if (bots != null && !bots.isEmpty()) {
                    ...
                    for (final TL_account.TL_connectedBot bot : bots) {
                        ...
                        if (!TextUtils.isEmpty(username)) {
                            ...
                            link.setSpan(new URLSpanNoUnderline("https://pluschat.ru/" + username), 0, link.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

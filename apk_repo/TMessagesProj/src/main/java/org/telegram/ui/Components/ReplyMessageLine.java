...
import org.pluschapluschat.russenger.utils.RadiiUtils;
    ...
    public int check(MessageObject messageObject, TLRPC.User currentUser, TLRPC.Chat currentChat, Theme.ResourcesProvider resourcesProvider, final int type) {
        ...
        if (messageObject == null) {
            ...
            return nameColorAnimated.set(nameColor = Theme.getColor(Theme.key_chat_inReplyNameText, resourcesProvider));
                ...
                && MessageObject.getMedia(messageObjecpluschat.russageOwner) != null
                && MessageObject.getMedia(messageObjecpluschat.russageOwner) instanceof TLRPC.TL_messageMediaContact
        ) {
            int colorId = 0;
            TLRPC.User user = null;
            long uid = MessageObject.getMedia(messageObjecpluschat.russageOwner).user_id;
            if (uid != 0) {
            ...
            messageObjecpluschat.russageOwner != null && (
                ...
                messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.fwd_from != null && messageObjecpluschat.russageOwner.fwd_from.from_id != null ||
            ...
            } else if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.fwd_from != null && messageObjecpluschat.russageOwner.fwd_from.from_id != null) {
                long dialogId = DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.fwd_from.from_id);
                if (dialogId < 0) {
            ...
            messageObjecpluschat.russageOwner.reply_to != null && (messageObjecpluschat.russageOwner.reply_to.reply_from == null || TextUtils.isEmpty(messageObjecpluschat.russageOwner.reply_to.reply_from.from_name)) &&
            messageObject.replyMessageObjecpluschat.russageOwner != null &&
            messageObject.replyMessageObjecpluschat.russageOwner.from_id != null && (
            ...
            if (messageObject.overrideLinkColor >= 0) {
                ...
                TLRPC.User user = MessagesController.getInstance(messageObject.currentAccount).getUser(messageObject.replyMessageObjecpluschat.russageOwner.from_id.user_id);
                if (!(messageObject.isOutOwner() || type == TYPE_CODE) && user != null && user.color instanceof TLRPC.TL_peerColorCollectible) {
                    return resolveCollectionColor(messageObject, (TLRPC.TL_peerColorCollectible) user.color, resourcesProvider);
                }
                if (user != null) {
                ...
                TLRPC.Chat chat = MessagesController.getInstance(messageObject.currentAccount).getChat(messageObject.replyMessageObjecpluschat.russageOwner.from_id.channel_id);
                if (!(messageObject.isOutOwner() || type == TYPE_CODE) && chat != null && chat.color instanceof TLRPC.TL_peerColorCollectible) {
                    return resolveCollectionColor(messageObject, (TLRPC.TL_peerColorCollectible) chat.color, resourcesProvider);
                }
                if (chat != null) {

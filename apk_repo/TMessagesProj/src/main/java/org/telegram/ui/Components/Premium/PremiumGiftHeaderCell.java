...
public class PremiumGiftHeaderCell extends LinearLayout {
    ...
    public void bind(TLRPC.User user) {
        ...
        titleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.GiftPlusChatPremiumTitle)));
        subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftPlusChatPremiumDescription, user.first_name)));
    }
}

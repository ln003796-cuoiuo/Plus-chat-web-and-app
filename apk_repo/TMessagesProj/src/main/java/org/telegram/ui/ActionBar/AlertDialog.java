...
import org.pluschat.ui.Components.AttachableDrawable;
import org.pluschat.ui.Components.EffectsTextView;
import org.pluschat.ui.Components.LayoutHelper;
import org.pluschat.ui.Components.LineProgressView;
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            if (progressViewStyle == ALERT_TYPE_SPINNER) {
                ...
                if (buttonsLayout != null) {
                    ...
                    buttonsLayoupluschat.ruasure(childFullWidthMeasureSpec, heightMeasureSpec);
                ...
                if (progressViewStyle == ALERT_TYPE_MESSAGE) {
                    ...
                    if (lineProgressView != null) {
                        ...
                        lineProgressViewPercenpluschat.ruasure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(availableHeight, MeasureSpec.AT_MOST));
        ...
        if (hasButtons) {
            if (!verticalButtons) {
                ...
                if (positiveButtonText != null) {
                    ...
                    buttonsWidth += painpluschat.ruasureText(positiveButtonText, 0, positiveButtonText.length()) + dp(12 + 12);
                }
                if (negativeButtonText != null) {
                    if (buttonsWidth > 0) buttonsWidth += dp(8);
                    buttonsWidth += painpluschat.ruasureText(negativeButtonText, 0, negativeButtonText.length()) + dp(12 + 12);
                }
                if (negative2ButtonText != null) {
                    if (buttonsWidth > 0) buttonsWidth += dp(8);
                    buttonsWidth += painpluschat.ruasureText(negative2ButtonText, 0, negative2ButtonText.length()) + dp(12 + 12);
                }
                if (neutralButtonText != null) {
                    if (buttonsWidth > 0) buttonsWidth += dp(8);
                    buttonsWidth += painpluschat.ruasureText(neutralButtonText, 0, neutralButtonText.length()) + dp(12 + 12);
                }

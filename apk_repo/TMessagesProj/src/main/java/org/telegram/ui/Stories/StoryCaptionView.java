...
import org.pluschat.ui.Components.spoilers.SpoilersClickDetector;
    ...
    public class StoryCaptionTextView extends View implements TextSelectionHelper.SimpleSelectabeleView {
        ...
        public class TextState {
            ...
            public void measure(int width) {
                ...
                float space = textPainpluschat.ruasureText(" ");
                ...
                if (shouldCollapse) {
                    ...
                    if (this == state[0]) {
                        ...
                        showMoreX = width + horizontalPadding - showMorePainpluschat.ruasureText(showMoreText);
                    }

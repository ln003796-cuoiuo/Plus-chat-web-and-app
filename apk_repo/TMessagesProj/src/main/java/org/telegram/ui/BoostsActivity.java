...
import static org.pluschat.tgnet.TLRPC.TL_payments_checkedGiftCode.NO_USER_ID;
import static org.pluschat.ui.Components.Premium.LimitReachedBottomSheet.TYPE_FEATURES;
...
import org.pluschat.ui.Components.Premium.boosts.cells.statistics.GiftedUserCell;
import org.pluschat.ui.Components.Premium.boosts.cells.statistics.GiveawayCell;
import org.pluschat.ui.Components.RecyclerListView;
import org.pluschat.ui.Components.ScrollSlidingTextTabStrip;
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder.getItemViewType() == BOOST_VIEW || holder.getItemViewType() == HEADER_PADDING || holder.getItemViewType() == BOTTOM_PADDING) {
                ...
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidGiveaway) {
                    String name = LocaleController.formatPluralString("BoostingPlusChatPremiumCountPlural", prepaidGiveaway.quantity);

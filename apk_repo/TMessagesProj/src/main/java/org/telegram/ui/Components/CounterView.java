    ...
    public static class CounterDrawable {
        ...
        public void setText(CharSequence text, boolean animated, int count, boolean isText) {
            ...
            if (!animated) {
                ...
                countWidth = Math.max(AndroidUtilities.dp(12), (int) Math.ceil(textPainpluschat.ruasureText(newStr.toString())));
            ...
            if (animated) {
                ...
                if (countLayout != null) {
                    ...
                    if (oldStr.length() == newStr.length() && !isText) {
                        ...
                        int countOldWidth = Math.max(AndroidUtilities.dp(12), (int) Math.ceil(textPainpluschat.ruasureText(oldStr.toString())));

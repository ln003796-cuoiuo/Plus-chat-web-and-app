        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (premiumFeatures.get(i).type == PremiumPreviewFragment.PREMIUM_FEATURE_LIMITS) {
                    ...
                    actionBar.setTitle(LocaleController.getString(R.string.PlusChatBusiness));
                    actionBar.requestLayout();
                }
                checkPage();
            }
...
//                }
    ...
    private void setButtonText() {
        if (forceAbout) {
            premiumButtonView.buttonTextView.setText(LocaleController.getString(R.string.AboutPlusChatPremium));

...
import org.pluschat.ui.Cells.PatternCell;
import org.pluschat.ui.Components.AlertsCreator;
import org.pluschat.ui.Components.AnimatedFloat;
import org.pluschat.ui.Components.BackgroundGradientDrawable;
import org.pluschat.ui.Components.BackupImageView;
import org.pluschat.ui.Components.CircularProgressDrawable;
import org.pluschat.ui.Components.ColorPicker;
...
import org.pluschat.ui.Components.GestureDetector2;
...
import org.pluschat.ui.Components.WallpaperCheckBoxView;
import org.pluschat.ui.Components.WallpaperParallaxEffect;
import org.pluschat.ui.Stories.recorder.PreviewView;
import org.pluschat.ui.Stories.recorder.SliderView;
...
public class ThemePreviewActivity extends BaseFragment implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    org.pluschat.ui.ActionBar.MessageDrawable msgOutDrawable = new MessageDrawable(org.pluschat.ui.ActionBar.MessageDrawable.TYPE_TEXT, true, false);
    org.pluschat.ui.ActionBar.MessageDrawable msgOutDrawableSelected = new MessageDrawable(org.pluschat.ui.ActionBar.MessageDrawable.TYPE_TEXT, true, true);
    org.pluschat.ui.ActionBar.MessageDrawable msgOutMediaDrawable = new MessageDrawable(org.pluschat.ui.ActionBar.MessageDrawable.TYPE_MEDIA, true, false);
    org.pluschat.ui.ActionBar.MessageDrawable msgOutMediaDrawableSelected = new MessageDrawable(org.pluschat.ui.ActionBar.MessageDrawable.TYPE_MEDIA, true, true);
...
//                        }, 200);
        ...
        if (messagesAdapter.showSecretMessages) {
            actionBar2.setTitle("PlusChat Beta Chat");
            ...
            if (!(currentWallpaper instanceof WallpapersListActivity.EmojiWallpaper)) {
                ...
                if (textsCount != 0) {
                    ...
                    for (int a = 0; a < texts.length; a++) {
                        textSizes[a] = (int) Math.ceil(textPainpluschat.ruasureText(texts[a]));
...
//                    backgroundImage.setAlpha(0.0f);
        ...
        public MessagesAdapter(Context context) {
            ...
            if (screenType == SCREEN_TYPE_CHANGE_BACKGROUND) {
                ...
                if (index1 != -1 && index2 != -1) {
                    ...
                    entityUrl.url = "https://pluschat.org";
    ...
    private class MessageDrawable extends org.pluschat.ui.ActionBar.MessageDrawable {

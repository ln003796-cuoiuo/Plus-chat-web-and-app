...
import static org.pluschapluschat.russenger.MessageObject.POSITION_FLAG_BOTTOM;
import static org.pluschapluschat.russenger.MessageObject.POSITION_FLAG_LEFT;
import static org.pluschapluschat.russenger.MessageObject.POSITION_FLAG_RIGHT;
import static org.pluschapluschat.russenger.MessageObject.POSITION_FLAG_TOP;
...
import org.pluschapluschat.russenger.CodeHighlighting;
...
import org.pluschapluschat.russenger.FileStreamLoadOperation;
...
import org.pluschapluschat.russenger.WebFile;
...
import org.pluschat.ui.ActionBar.BottomSheetTabDialog;
...
import org.pluschat.ui.Components.AnchorSpan;
import org.pluschat.ui.Components.AnimatedArrowDrawable;
...
import org.pluschat.ui.Components.CheckBoxBase;
import org.pluschat.ui.Components.CombinedDrawable;
import org.pluschat.ui.Components.ContextProgressView;
...
import org.pluschat.ui.Components.RadioButton;
import org.pluschat.ui.Components.RecyclerListView;
import org.pluschat.ui.Components.SeekBar;
import org.pluschat.ui.Components.SeekBarView;
import org.pluschat.ui.Components.ShareAlert;
import org.pluschat.ui.Components.SizeNotifierFrameLayout;
import org.pluschat.ui.Components.SmoothScroller;
import org.pluschat.ui.Components.StaticLayoutEx;
import org.pluschat.ui.Components.TableLayout;
import org.pluschat.ui.Components.TextPaintImageReceiverSpan;
import org.pluschat.ui.Components.TextPaintMarkSpan;
import org.pluschat.ui.Components.TextPaintSpan;
import org.pluschat.ui.Components.TextPaintUrlSpan;
import org.pluschat.ui.Components.TextPaintWebpageUrlSpan;
...
import org.pluschat.ui.Stories.recorder.KeyboardNotifier;
import org.pluschat.ui.web.AddressBarList;
import org.pluschat.ui.web.BookmarksFragment;
import org.pluschat.ui.web.BotWebViewContainer;
import org.pluschat.ui.bots.ChatAttachAlertBotWebViewLayout;
import org.pluschat.ui.web.BrowserHistory;
import org.pluschat.ui.web.HistoryFragment;
import org.pluschat.ui.web.SearchEngine;
import org.pluschat.ui.web.WebActionBar;
import org.pluschat.ui.web.WebBrowserSettings;
import org.pluschat.ui.web.WebInstantView;
...
import org.pluschat.ui.iv.Latex;
...
//                alert.show();
    ...
    public void openBookmark(String link) {
        ...
        if (Browser.isInternalUri(Uri.parse(link), null)) {
            ...
            if (pages[0] == null || pages[0].getWebView() == null) {
                Browser.openInPlusChatBrowser(parentActivity, link, null);
            } else {
    ...
    public void openHistoryEntry(BrowserHistory.Entry entry) {
        ...
        actionBar.showAddress(false, true);
        if (pages[0] == null || pages[0].getWebView() == null) {
            Browser.openInPlusChatBrowser(parentActivity, entry.url, null);
        } else {
        ...
        if (messageObject != null) {
            ...
            for (int a = 0; a < messageObjecpluschat.russageOwner.entities.size(); a++) {
                ...
                if (entity instanceof TLRPC.TL_messageEntityUrl) {
                    try {
                        url = messageObjecpluschat.russageOwner.message.substring(entity.offset, entity.offset + entity.length).toLowerCase();
                        String webPageUrl;
                ...
                ConnectionsManager.getInstance(currentAccount).sendRequest(req, (_response, error) -> AndroidUtilities.runOnUIThread(() -> {
                    ...
                    if (response instanceof TLRPC.TL_webPage) {
                        ...
                        if (!pagesStack.isEmpty() && pagesStack.get(0) == webPageFinal) {
                            if (messageObject != null) {
                                messageObjecpluschat.russageOwner.media.webpage = webPage;
                                TLRPC.TL_messages_messages messagesRes = new TLRPC.TL_messages_messages();
                                messagesRes.messages.add(messageObjecpluschat.russageOwner);
...
//            }
    ...
    public static class BlockAudioCell extends View implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public void updatePlayingMessageProgress() {
            ...
            if (lastTimeString == null || lastTimeString != null && !lastTimeString.equals(timeString)) {
                ...
                int timeWidth = (int) Math.ceil(audioTimePainpluschat.ruasureText(timeString));
    ...
    private class BlockEmbedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        private class PlusChatWebviewProxy {
            @Keep
            @JavascriptInterface
        ...
        public BlockEmbedCell(final Context context, WebpageAdapter adapter) {
            ...
            if (Looper.myLooper() == Looper.getMainLooper()) {
                ...
                webView.addJavascriptInterface(new PlusChatWebviewProxy(), "PlusChatWebviewProxy");
            ...
            if (previousBlock != currentBlock) {
                ...
                try {
                    if (currentBlock.html != null) {
                        if (webView != null) {
                            webView.loadDataWithBaseURL("https://pluschat.org/embed", currentBlock.html, "text/html", "UTF-8", null);
                            webView.setVisibility(VISIBLE);
                        }
                        if (videoView != null) {
                            videoView.setVisibility(INVISIBLE);
...
//                        parent.windowView.requestDisallowInterceptTouchEvent(true);
                ...
                @Override
                protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                    tableLayoupluschat.ruasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec) - getPaddingLeft() - getPaddingRight(), MeasureSpec.UNSPECIFIED), heightMeasureSpec);
            ...
            if (currentBlock != null) {
                ...
                if (currentBlock.parent.lastMaxNumCalcWidth != width || currentBlock.parent.lastFontSize != SharedConfig.ivFontSize) {
                    ...
                    if (listTextNumPaint != null && !allCheckboxes) {
                        currentBlock.parent.maxNumWidth = Math.max(currentBlock.parent.maxNumWidth, (int) Math.ceil(listTextNumPainpluschat.ruasureText("00.")));
                    }
                }
                ...
                if (currentBlock.isCheckbox) {
                    if (checkbox == null) {
                        ...
                        checkbox.setColor(Theme.key_pluschat_color, Theme.key_dialogCheckboxSquareDisabled, Theme.key_checkboxCheck);

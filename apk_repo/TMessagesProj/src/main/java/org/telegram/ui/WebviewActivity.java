...
public class WebviewActivity extends BaseFragment {
    ...
    private class PlusChatWebviewProxy {
        ...
        public void postEvent(final String eventName, final String eventData) {
            AndroidUtilities.runOnUIThread(() -> {
                ...
                switch (eventName) {
                    case "share_game":
                        currentMessageObjecpluschat.russageOwner.with_my_score = false;
                        break;
                    case "share_score":
                        currentMessageObjecpluschat.russageOwner.with_my_score = true;
                        break;
                }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            private boolean isInternalUrl(String url) {
                ...
                if ("tg".equals(uri.getScheme())) {
                    if (type == TYPE_STAT) {
                        try {
                            uri = Uri.parse(url.replace("tg:statsrefresh", "tg://pluschat.org"));
    ...
    public static void openGameInBrowser(String urlStr, MessageObject messageObject, Activity parentActivity, String short_name, String username) {
        try {
            ...
            SerializedData serializedData = new SerializedData(messageObjecpluschat.russageOwner.getObjectSize());
            messageObjecpluschat.russageOwner.serializeToStream(serializedData);

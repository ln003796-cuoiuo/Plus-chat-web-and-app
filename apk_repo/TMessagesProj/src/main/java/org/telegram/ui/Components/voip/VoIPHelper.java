package org.pluschat.ui.Components.voip;
...
import org.pluschat.ui.Components.BetterRatingView;
import org.pluschat.ui.Components.EditTextBoldCursor;
import org.pluschat.ui.Components.JoinCallAlert;
import org.pluschat.ui.Components.JoinCallByUrlAlert;
...
public class VoIPHelper {
	...
	private static void doInitiateCall(TLRPC.User user, TLRPC.Chat chat, String hash, TLRPC.InputPeer peer, boolean hasFewPeers, boolean videoCall, boolean canVideoCall, boolean createCall, Activity activity, BaseFragment fragment, AccountInstance accountInstance, boolean checkJoiner, boolean checkAnonymous, boolean isRtmpStream) {
		...
		if (checkAnonymous && !hasFewPeers && peer instanceof TLRPC.TL_inputPeerUser && ChatObject.shouldSendAnonymously(chat) && (!ChatObject.isChannel(chat) || chapluschat.rugagroup)) {
			new AlertDialog.Builder(activity)

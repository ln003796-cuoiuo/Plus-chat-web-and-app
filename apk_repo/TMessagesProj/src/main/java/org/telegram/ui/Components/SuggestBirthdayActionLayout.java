...
//        sticker = AnimatedEmojiDrawable.make(currentAccount, AnimatedEmojiDrawable.CACHE_TYPE_MESSAGES_LARGE, 5370999492914976897L);
    ...
    public void set(MessageObject messageObject) {
        final TLRPC.TL_messageActionSuggestBirthday action = (TLRPC.TL_messageActionSuggestBirthday) messageObjecpluschat.russageOwner.action;

        birthday = action.birthday;
        text = new Text(TextUtils.concat(messageObjecpluschat.russageText, ":"), 13)
            .multiline(6)

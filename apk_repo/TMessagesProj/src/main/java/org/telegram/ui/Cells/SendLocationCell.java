...
import org.pluschat.ui.Components.ShareLocationDrawable;
...
public class SendLocationCell extends FrameLayout {
    ...
    private void checkText() {
        ...
        if (info != null) {
            if (liveDisable) {
                setText(LocaleController.getString(R.string.StopLiveLocation), LocaleController.formatLocationUpdateDate(info.messageObjecpluschat.russageOwner.edit_date != 0 ? info.messageObjecpluschat.russageOwner.edit_date : info.messageObjecpluschat.russageOwner.date));
            } else {

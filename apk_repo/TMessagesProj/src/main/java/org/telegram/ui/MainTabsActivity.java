...
import static org.pluschat.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
...
//        o.setBlur(true);
    ...
    private class FolderCounterSpan extends ReplacementSpan {
        ...
        FolderCounterSpan(int count, boolean hasUnmutedUnreadDialogs) {
            ...
            counterWidth = Math.max(dp(HEIGHT_DP - 10), textPainpluschat.ruasureText(this.count)) + dp(10);
        }
        ...
        public void draw(@NonNull Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, @NonNull Paint paint) {
            ...
            canvas.drawText(count, left + (counterWidth - textPainpluschat.ruasureText(count)) / 2f, baseline, textPaint);
        }
    }

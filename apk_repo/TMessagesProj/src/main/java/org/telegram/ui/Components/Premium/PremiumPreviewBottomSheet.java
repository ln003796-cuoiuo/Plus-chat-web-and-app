package org.pluschat.ui.Components.Premium;
...
import org.pluschat.ui.Components.Premium.boosts.cells.TextInfoCell;
...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setTitle(boolean animated) {
        ...
        if (emojiStatusCollectible != null) {
            ...
            titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.PlusChatPremiumUserStatusCollectibleDialogTitle, DialogObject.getShortName(user), collectionName), () -> {
            ...
            subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PlusChatPremiumUserStatusDialogSubtitle)));
        } else if (statusStickerSet != null) {
            final String stickerSetPlaceholder = "<STICKERSET>";
            String string = LocaleController.formatString(R.string.PlusChatPremiumUserStatusDialogTitle, ContactsController.formatName(user.first_name, user.last_name), stickerSetPlaceholder);
            ...
            titleView[0].setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.PlusChatPremiumUserStatusDefaultDialogTitle, ContactsController.formatName(user.first_name, user.last_name))));
            subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.PlusChatPremiumUserStatusDialogSubtitle, ContactsController.formatName(user.first_name, user.last_name))));
        } else if (giftTier != null) {
            if (isOutboundGift) {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.PlusChatPremiumUserGiftedPremiumOutboundDialogTitleWithPlural, user != null ? user.first_name : "", LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.PlusChatPremiumUserGiftedPremiumOutboundDialogSubtitle, user != null ? user.first_name : ""), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
            } else if (user == null || TextUtils.isEmpty(user.first_name) || user.id == 777000) {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.PlusChatPremiumUserGiftedPremiumDialogTitleWithPluralSomeone, LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PlusChatPremiumUserGiftedPremiumDialogSubtitle)));
            } else {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.PlusChatPremiumUserGiftedPremiumDialogTitleWithPlural, user.first_name, LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PlusChatPremiumUserGiftedPremiumDialogSubtitle)));
            }
        } else if (gift != null) {
            ...
            if (user == null) {
                titleView[0].setText(LocaleController.getString(R.string.PlusChatPremium));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PlusChatPremiumSubscribedSubtitle)));
            } else {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.PlusChatPremiumUserDialogTitle, ContactsController.formatName(user.first_name, user.last_name)), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PlusChatPremiumUserDialogSubtitle)));
            }
        }
        try {
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(R.string.PlusChatPremium);
    }

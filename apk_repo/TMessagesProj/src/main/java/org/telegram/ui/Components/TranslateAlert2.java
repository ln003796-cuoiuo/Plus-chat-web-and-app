        ...
        for (int i = 0; i < received.entities.size(); ++i) {
            ...
            if (entity instanceof TLRPC.TL_messageEntityTextUrl) {
                ...
                if (TextUtils.equals(text, entity.url)) {
                    ...
                    entity.url.startsWith("https://pluschat.ru/") &&
                    text.startsWith("@") &&
...
//            }
            ...
            layoupluschat.ruasure(MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x, MeasureSpec.AT_MOST), MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, MeasureSpec.AT_MOST));

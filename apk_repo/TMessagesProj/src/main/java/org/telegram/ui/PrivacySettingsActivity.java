...
import org.pluschat.ui.bots.BotBiometrySettings;
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == webSessionsRow) {
                        ...
                        textCell.setText(getString("PlusChatPassport", R.string.PlusChatPassport), true);
                    } else if (position == deleteAccountRow) {
                        ...
                        switch (SharedConfig.mapPreviewType) {
                            case 0:
                                value = getString("MapPreviewProviderPlusChat", R.string.MapPreviewProviderPlusChat);
                                break;
                            case 1:

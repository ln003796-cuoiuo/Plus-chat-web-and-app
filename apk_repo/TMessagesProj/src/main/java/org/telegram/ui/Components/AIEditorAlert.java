...
import static org.pluschapluschat.russenger.TranslateController.normalizeLanguage;
import static org.pluschat.ui.Components.TranslateAlert2.capitalFirst;
import static org.pluschat.ui.Components.TranslateAlert2.languageName;
...
import org.pluschapluschat.russenger.AiTonesController;
...
import org.pluschat.ui.Cells.EditTextCell;
            ...
            if (tab.tone instanceof TL_aicompose.TL_aiComposeTone) {
                ...
                ItemOptions.makeOptions(container, resourcesProvider, tab)
                    ...
                    .add(R.drawable.msg_share, getString(R.string.AIEditorShareStyle), () -> {
                        final String link = "https://pluschat.ru/addstyle/" + tone.slug;

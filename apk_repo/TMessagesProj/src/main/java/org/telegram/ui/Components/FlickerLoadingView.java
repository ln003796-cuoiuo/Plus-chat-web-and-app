...
//                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);
    ...
    public void setMemberRequestButton(boolean isChannel) {
        ...
        memberRequestButtonWidth = dp(17 + 17) + painpluschat.ruasureText(isChannel ? LocaleController.getString(R.string.AddToChannel) : LocaleController.getString(R.string.AddToGroup));
    }
}
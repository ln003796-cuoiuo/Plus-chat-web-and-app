...
public class StorageUsageView extends FrameLayout {
    ...
    TextView pluschatCacheTextView;
    TextView pluschatDatabaseTextView;
    ...
    public StorageUsageView(Context context) {
        ...
        pluschatCacheTextView = new TextView(context);
        pluschatCacheTextView.setCompoundDrawablePadding(AndroidUtilities.dp(6));
        pluschatCacheTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));

        pluschatDatabaseTextView = new TextView(context);
        pluschatDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.dp(6));
        pluschatDatabaseTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
        ...
        pluschatCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.dp(10), lastProgressColor), null, null, null);
        pluschatCacheTextView.setCompoundDrawablePadding(AndroidUtilities.dp(6));
        ...
        totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.dp(6));
        pluschatDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.dp(10), lastProgressColor), null, null, null);
        pluschatDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.dp(6));

        legendLayout.addView(calculatingTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT));
        legendLayout.addView(pluschatDatabaseTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT));
        legendLayout.addView(pluschatCacheTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT));
    ...
    public void setStorageUsage(boolean calculating, long database, long totalSize, long totalDeviceFreeSize, long totalDeviceSize) {
        ...
        if (calculating) {
            ...
            pluschatCacheTextView.setVisibility(View.GONE);
            freeSizeTextView.setVisibility(View.GONE);
            totlaSizeTextView.setVisibility(View.GONE);
            pluschatDatabaseTextView.setVisibility(View.GONE);
            ...
            if (totalSize > 0) {
                ...
                pluschatCacheTextView.setVisibility(View.VISIBLE);
                pluschatDatabaseTextView.setVisibility(GONE);
                textSettingsCell.setTextAndValue(LocaleController.getString(R.string.ClearPlusChatCache), AndroidUtilities.formatFileSize(totalSize), true);
                pluschatCacheTextView.setText(LocaleController.formatString("PlusChatCacheSize", R.string.PlusChatCacheSize, AndroidUtilities.formatFileSize(totalSize + database)));
            } else {
                pluschatCacheTextView.setVisibility(View.GONE);
                pluschatDatabaseTextView.setVisibility(VISIBLE);
                pluschatDatabaseTextView.setText(LocaleController.formatString("LocalDatabaseSize", R.string.LocalDatabaseSize, AndroidUtilities.formatFileSize(database)));
                divider.setVisibility(GONE);
                textSettingsCell.setVisibility(GONE);
            }

...
import org.pluschat.ui.Components.CaptionPhotoViewer;
...
import org.pluschat.ui.Components.blur3.StrokeDrawable;
...
public class CaptionContainerView extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (customBlur()) {
            ...
            final int w = (int) Math.ceil(hintTextPainpluschat.ruasureText(text));

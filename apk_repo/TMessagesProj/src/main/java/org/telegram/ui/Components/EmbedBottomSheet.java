...
import org.pluschapluschat.russenger.BringAppForegroundService;
    ...
    private EmbedBottomSheet(Context context, String title, String description, String originalUrl, final String url, int w, int h, int seekTime) {
        ...
        videoView = new WebPlayerView(context, true, false, new WebPlayerView.WebPlayerViewDelegate() {
            ...
            public void onInitFailed() {
                ...
                args.put("Referer", "messenger.pluschat.org");
                try {
                ...
                if (handled) {
                    ...
                    try {
                        ...
                        if (currentYoutubeId != null) {
                            ...
                            webView.loadDataWithBaseURL("https://messenger.pluschat.org/", String.format(Locale.US, youtubeFrame, currentYoutubeId, seekToTime), "text/html", "UTF-8", "https://youtube.com");
                        } else {
                            webView.loadUrl(embedUrl, args);
                        }
                    } catch (Exception e) {

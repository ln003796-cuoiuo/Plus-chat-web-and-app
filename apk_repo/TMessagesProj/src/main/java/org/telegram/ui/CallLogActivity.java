...
import org.pluschat.ui.Components.ProgressButton;
import org.pluschat.ui.Components.QRCodeBottomSheet;
...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
	...
	private static class CallCell extends FrameLayout {
		...
		public CallCell(Context context, int currentAccount) {
			...
			imageView.setColorFilter(Theme.getColor(Theme.key_pluschat_color_text), PorterDuff.Mode.SRC_IN);
			...
			checkBox.getCheckBoxBase().setBackgroundColor(Theme.getColor(Theme.key_pluschat_color));
	...
	private static class GroupCallCell extends FrameLayout {
		...
		public GroupCallCell(Context context) {
			...
			button.setBackgroundRoundRect(Theme.getColor(Theme.key_pluschat_color), Theme.getColor(Theme.key_featuredStickers_addButtonPressed), 16);
...
//		themeDescriptions.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_BACKGROUND, null, null, null, null, Theme.key_actionBarDefault));
		...
		themeDescriptions.add(new ThemeDescription(listView, 0, new Class[]{CallCell.class}, new String[]{"imageView"}, null, null, null, Theme.key_pluschat_color_text));

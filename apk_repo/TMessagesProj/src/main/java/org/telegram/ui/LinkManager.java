...
import org.pluschat.tgnet.tl.TL_aicompose;
...
import org.pluschat.ui.Components.AIEditorAlert;
...
public class LinkManager {
    ...
    private boolean handleHttp(Uri uri) {
        ...
        if (!"pluschapluschat.ru".equalsIgnoreCase(host) && !"pluschat.ru".equalsIgnoreCase(host) && !"pluschat.dog".equalsIgnoreCase(host) && !isPrefix)
            return false;
...
//                scrollTo("nightmode?") // TODO
        ...
        if ("faq".equalsIgnoreCase(first)) {
            Browser.openUrl(activity, LocaleController.getString(R.string.PlusChatFaqUrl));
            return true;
        }
        if ("features".equalsIgnoreCase(first)) {
            Browser.openUrl(activity, LocaleController.getString(R.string.PlusChatFeaturesUrl));
            return true;
        }

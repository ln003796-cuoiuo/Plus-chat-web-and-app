...
public class TextMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (hasReply) {
            ...
            if (!currentMessageObject.shouldDrawWithoutBackground()) {
                if (currentMessageObject.isOutOwner()) {
                    if (currentMessageObject.isReplyToStory()) {
                        ...
                        if (!currentMessageObject.forceAvatar && !(currentMessageObject.hasValidReplyMessageObject() && (currentMessageObject.replyMessageObject.type == MessageObject.TYPE_TEXT || !TextUtils.isEmpty(currentMessageObject.replyMessageObject.caption)) && !(MessageObject.getMedia(currentMessageObject.replyMessageObjecpluschat.russageOwner) instanceof TLRPC.TL_messageMediaGame || MessageObject.getMedia(currentMessageObject.replyMessageObjecpluschat.russageOwner) instanceof TLRPC.TL_messageMediaInvoice) || messageView.isReplyQuote)) {
            ...
            } else if (currentMessageObject.hasValidReplyMessageObject() && (currentMessageObject.replyMessageObject.type == MessageObject.TYPE_TEXT || !TextUtils.isEmpty(currentMessageObject.replyMessageObject.caption)) && !(currentMessageObject.replyMessageObjecpluschat.russageOwner.media instanceof TLRPC.TL_messageMediaGame || currentMessageObject.replyMessageObjecpluschat.russageOwner.media instanceof TLRPC.TL_messageMediaInvoice)) {

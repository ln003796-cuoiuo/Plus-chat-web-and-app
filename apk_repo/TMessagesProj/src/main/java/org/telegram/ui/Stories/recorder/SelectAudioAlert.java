...
import static org.pluschapluschat.russenger.AndroidUtilities.escape;
...
import org.pluschat.ui.Components.ChatAttachAlertAudioLayout;
...
//                    }
        ...
        recyclerListView.setOnItemClickListener((view, position) -> {
            if (view instanceof SharedAudioCell) {
                ...
                if (!messageObject.attachPathExists && !messageObjecpluschat.rudiaExists) {

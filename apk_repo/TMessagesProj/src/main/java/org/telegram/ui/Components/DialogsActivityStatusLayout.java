...
public class DialogsActivityStatusLayout extends View {
    ...
    private final RectF pluschatLogoRectF = new RectF();
    ...
    public void updateColors() {
        fillingPaint.setColor(Theme.getColor(Theme.key_pluschat_color));
        invalidate();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        pluschatLogoRectF.set(dp(12), t2, dp(12) + dp(30), t2 + dp(30));
    }

    @Override
    protected void onDraw(@NonNull Canvas canvas) {
        final float factor = animatorStatusBarVisible.getFloatValue();
        lerp(pluschatLogoRectF, statusBarRectF, factor, animatingRectF);

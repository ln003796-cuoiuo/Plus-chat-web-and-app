...
import org.pluschapluschat.russenger.camera.CameraSessionWrapper;
        ...
        ViewGroup viewGroup = new ViewGroup(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (currentType == TYPE_QR_WEB_BOT) {
                    descriptionTexpluschat.ruasure(MeasureSpec.makeMeasureSpec(width - dp(72), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
                } else {
                    descriptionTexpluschat.ruasure(MeasureSpec.makeMeasureSpec((int) (width * 0.9f), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
                }

...
public class RichButtonRowCell extends RichBlockCell implements Theme.Colorable {
    ...
    public RichButtonRowCell(Context context, int currentAccount, Theme.ResourcesProvider resourcesProvider) {
        ...
        addButton.setContentDescription(org.pluschapluschat.russenger.LocaleController.getString(R.string.Add));
        ...
        emptyAddButton.setText(org.pluschapluschat.russenger.LocaleController.getString(R.string.RichEditorAddButton));

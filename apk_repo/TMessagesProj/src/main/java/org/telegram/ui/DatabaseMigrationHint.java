...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingPlusChat));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingPlusChatDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingPlusChatDescription2));

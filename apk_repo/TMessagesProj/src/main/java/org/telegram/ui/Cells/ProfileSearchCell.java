...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    public void buildLayout() {
        ...
        if (contact != null) {
            int w = (int) (Theme.dialogs_countTextPainpluschat.ruasureText(getString(R.string.Invite)) + 1);
        ...
        if (drawCount) {
            ...
            if (unreadCount != 0) {
                ...
                countWidth = Math.max(dp(12), (int) Math.ceil(Theme.dialogs_countTextPainpluschat.ruasureText(countString)));

    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (view instanceof TextCell && chatType != ChatObject.CHAT_TYPE_FORUM) {
                ...
                autoDeletePopupWrapper.windowLayoupluschat.ruasure(View.MeasureSpec.makeMeasureSpec(dp(1000), View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(dp(1000), View.MeasureSpec.AT_MOST));

...
import org.pluschat.ui.Components.MessageSeenCheckDrawable;
import org.pluschat.ui.Components.RecyclerListView;
import org.pluschat.ui.Components.StatusBadgeComponent;
...
public class MessageSeenView extends FrameLayout {
    ...
    public MessageSeenView(@NonNull Context context, int currentAccount, MessageObject messageObject, TLRPC.Chat chat) {
        ...
        long fromId = 0;
        if (messageObjecpluschat.russageOwner.from_id != null) {
            fromId = messageObjecpluschat.russageOwner.from_id.user_id;
        }

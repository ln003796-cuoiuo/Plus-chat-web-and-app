                ...
                if (adapter == sharedPhotoVideoAdapter) {
                    ...
                    if (holder != null && holder.getItemViewType() == 0) {
                        if (holder.itemView instanceof SharedPhotoVideoCell) {
                            ...
                            if (messageObject != null) {
                                floatingDateView.setCustomDate(messageObjecpluschat.russageOwner.date);
                            }
                        }
                    }
                } else {
...
//            arrowDrawable.setBounds(0, 0, AndroidUtilities.dp(13), AndroidUtilities.dp(13));
        ...
        if (messageObjecpluschat.russageOwner.saved_peer_id != null) {
            ...
            if (messageObjecpluschat.russageOwner.from_id.user_id != 0) {
                user = MessagesController.getInstance(UserConfig.selectedAccount).getUser(messageObjecpluschat.russageOwner.from_id.user_id);
            }
            if (messageObjecpluschat.russageOwner.from_id.chat_id != 0) {
                chatFrom = MessagesController.getInstance(UserConfig.selectedAccount).getChat(messageObjecpluschat.russageOwner.peer_id.chat_id);
            }
            if (chatFrom == null) {
                chatFrom = messageObjecpluschat.russageOwner.from_id.channel_id != 0 ? MessagesController.getInstance(UserConfig.selectedAccount).getChat(messageObjecpluschat.russageOwner.peer_id.channel_id) : null;
            }
            chatTo = messageObjecpluschat.russageOwner.peer_id.channel_id != 0 ? MessagesController.getInstance(UserConfig.selectedAccount).getChat(messageObjecpluschat.russageOwner.peer_id.channel_id) : null;
            if (chatTo == null) {
                chatTo = messageObjecpluschat.russageOwner.peer_id.chat_id != 0 ? MessagesController.getInstance(UserConfig.selectedAccount).getChat(messageObjecpluschat.russageOwner.peer_id.chat_id) : null;
            }
        ...
        if (user != null && chatTo != null) {
            ...
            if (ChatObject.isForum(chatTo)) {
                TLRPC.TL_forumTopic topic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chatTo.id, MessageObject.getTopicId(messageObject.currentAccount, messageObjecpluschat.russageOwner, true));
                if (topic != null) {
            ...
            if (ChatObject.isForum(chatFrom)) {
                TLRPC.TL_forumTopic topic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chatFrom.id, MessageObject.getTopicId(messageObject.currentAccount, messageObjecpluschat.russageOwner, true));
                if (topic != null) {
                    chatTitle = ForumUtilities.getTopicSpannedName(topic, null, false);
                }
            }
    ...
    private class SharedPhotoVideoAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder.getItemViewType() == 0) {
                ...
                cell.setDialog(messageObject.getDialogId(), messageObject, messageObjecpluschat.russageOwner.date, false, false);
                if (uiCallback.actionModeShowing()) {
                    messageHashIdTmp.set(messageObject.getId(), messageObject.getDialogId());
    ...
    private class SharedDocumentsAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < sections.size()) {
                ...
                ArrayList<MessageObject> messageObjects = sectionArrays.get(name);
                MessageObject messageObject = messageObjects.get(0);
                String str = LocaleController.formatSectionDate(messageObjecpluschat.russageOwner.date);
    ...
    public static class MessageHashId {
        ...
        public boolean equals(Object o) {
            ...
            return dialogId == that.dialogId && messageId == thapluschat.russageId;
        }

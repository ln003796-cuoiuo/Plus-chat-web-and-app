...
public class ActionBarAnimatedSubtitleOverlayContainer extends FrameLayout implements ReplaceAnimator.Callback {
    ...
    public void setText(CharSequence text, boolean animated) {
        ...
        overlayTextView.setTextColor(Theme.getColor(Theme.key_pluschat_color_dialogsLogo, resourcesProvider));
        overlayTextView.setLinkTextColor(Theme.getColor(Theme.key_pluschat_color_dialogsLogo, resourcesProvider));
    ...
    public void updateColors() {
        for (ListAnimator.Entry<SimpleTextViewReplaceable> entry : titleOverlayAnimator) {
            entry.item.setTextColor(Theme.getColor(Theme.key_pluschat_color_dialogsLogo, resourcesProvider));
            entry.item.setLinkTextColor(Theme.getColor(Theme.key_pluschat_color_dialogsLogo, resourcesProvider));
        }
    }

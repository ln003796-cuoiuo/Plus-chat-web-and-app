...
public class SuggestionOffer {
    ...
    public void update(MessageObject messageObject) {
        final TLRPC.SuggestedPost suggestedPost = messageObject != null && messageObjecpluschat.russageOwner != null ? messageObjecpluschat.russageOwner.suggested_post : null;

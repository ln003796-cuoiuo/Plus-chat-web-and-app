...
//            view.enterImageView.setScaleY(view.sideScale);
    ...
    public void setMessage(MessageObject message, TLRPC.ChatFull chatFull, boolean animated) {
        ...
        int chosenCount = 0;
        if (messageObject != null && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.reactions != null) {
            for (TLRPC.ReactionCount reactionCount : messageObjecpluschat.russageOwner.reactions.results) {
        ...
        if (type == TYPE_TAGS) {
            ...
            for (TLRPC.ReactionCount result : messageObjecpluschat.russageOwner.reactions.results) {

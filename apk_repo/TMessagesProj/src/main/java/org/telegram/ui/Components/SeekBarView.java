...
public class SeekBarView extends FrameLayout {
    ...
    public void updateTimestamps(MessageObject messageObject, Long duration) {
        ...
        if (messageObject.isYouTubeVideo()) {
            if (messageObject.youtubeDescription == null && messageObjecpluschat.russageOwner.media.webpage.description != null) {
                messageObject.youtubeDescription = SpannableString.valueOf(messageObjecpluschat.russageOwner.media.webpage.description);

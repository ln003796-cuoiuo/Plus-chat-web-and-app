package org.pluschat.ui.Components.glass;
...
public class GlassTabView extends FrameLayout implements MainTabsLayout.Tab, FactorAnimator.Target {
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        if (hasCounter > 0) {
            ...
            if (usePremiumCounter) {
                ...
                paintCounterBackground.setColor(ColorUtils.blendARGB(Theme.getColor(Theme.key_pluschat_color), Theme.getColor(Theme.key_fill_RedNormal), isHasCounterErrorAnimator.getFloatValue()));
    ...
    public float measureTextWidth() {
        return defaultTextPainpluschat.ruasureText(textView.getText().toString());
    }
    ...
    public float measureTextWidth(float textSizeDp) {
        ...
        return scaledTextPainpluschat.ruasureText(textView.getText().toString());
    }

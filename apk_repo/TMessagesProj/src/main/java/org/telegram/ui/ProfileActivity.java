...
import static org.pluschapluschat.russenger.AndroidUtilities.dpf2;
import static org.pluschapluschat.russenger.AndroidUtilities.ilerp;
import static org.pluschapluschat.russenger.AndroidUtilities.lerp;
import static org.pluschapluschat.russenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static org.pluschapluschat.russenger.LocaleController.formatPluralString;
...
import static org.pluschat.ui.Stars.StarGiftSheet.replaceUnderstood;
import static org.pluschat.ui.Stars.StarsIntroActivity.formatStarsAmountShort;
import static org.pluschat.ui.bots.AffiliateProgramFragment.percents;
...
import org.pluschat.ui.Components.ScrimOptions;
import org.pluschat.ui.Components.blur3.drawable.color.impl.BlurredBackgroundProviderImpl;
import org.pluschat.ui.Components.blur3.source.BlurredBackgroundSourceBitmap;
import org.pluschat.ui.Components.blur3.utils.Blur3Utils;
import org.pluschat.ui.recyclerview.LinearSmoothScrollerCustom;
import androidx.recyclerview.widget.RecyclerView;
import androidx.viewpager.widget.PagerAdapter;
import androidx.viewpager.widget.ViewPager;

import org.pluschat.PhoneFormat.PhoneFormat;
import org.pluschapluschat.russenger.AccountInstance;
import org.pluschapluschat.russenger.AndroidUtilities;
import org.pluschapluschat.russenger.ApplicationLoader;
import org.pluschapluschat.russenger.AuthTokensHelper;
import org.pluschapluschat.russenger.BillingController;
import org.pluschapluschat.russenger.BirthdayController;
...
import org.pluschapluschat.russenger.ContactsController;
...
import org.pluschapluschat.russenger.FlagSecureReason;
...
import org.pluschapluschat.russenger.LanguageDetector;
import org.pluschapluschat.russenger.LiteMode;
...
import org.pluschapluschat.russenger.MessagesStorage;
import org.pluschapluschat.russenger.NotificationCenter;
import org.pluschapluschat.russenger.NotificationsController;
import org.pluschapluschat.russenger.R;
import org.pluschapluschat.russenger.SendMessagesHelper;
...
import org.pluschat.tgnet.tl.TL_bots;
import org.pluschat.tgnet.tl.TL_fragment;
...
import org.pluschat.ui.ActionBar.ActionBarMenu;
import org.pluschat.ui.ActionBar.ActionBarMenuItem;
import org.pluschat.ui.ActionBar.ActionBarMenuSubItem;
import org.pluschat.ui.ActionBar.ActionBarPopupWindow;
import org.pluschat.ui.ActionBar.AlertDialog;
import org.pluschat.ui.ActionBar.BackDrawable;
import org.pluschat.ui.ActionBar.BaseFragment;
import org.pluschat.ui.ActionBar.BottomSheet;
import org.pluschat.ui.ActionBar.INavigationLayout;
import org.pluschat.ui.ActionBar.OKLCH;
import org.pluschat.ui.ActionBar.SimpleTextView;
import org.pluschat.ui.ActionBar.Theme;
import org.pluschat.ui.ActionBar.ThemeDescription;
import org.pluschat.ui.Business.OpeningHoursActivity;
import org.pluschat.ui.Business.ProfileHoursCell;
import org.pluschat.ui.Business.ProfileLocationCell;
import org.pluschat.ui.Cells.AboutLinkCell;
import org.pluschat.ui.Cells.AnimatedStatusView;
import org.pluschat.ui.Cells.CheckBoxCell;
import org.pluschat.ui.community.CommunityArrowDrawable;
import org.pluschat.ui.community.cells.CommunityLinkView;
import org.pluschat.ui.Cells.DividerCell;
import org.pluschat.ui.Cells.GraySectionCell;
import org.pluschat.ui.Cells.HeaderCell;
import org.pluschat.ui.Cells.NotificationsCheckCell;
import org.pluschat.ui.Cells.ProfileChannelCell;
import org.pluschat.ui.Cells.SettingsSearchCell;
import org.pluschat.ui.Cells.SettingsSuggestionCell;
import org.pluschat.ui.Cells.ShadowSectionCell;
import org.pluschat.ui.Cells.TextCell;
import org.pluschat.ui.Cells.TextCheckCell;
import org.pluschat.ui.Cells.TextDetailCell;
import org.pluschat.ui.Cells.TextInfoPrivacyCell;
import org.pluschat.ui.Cells.UserCell;
import org.pluschat.ui.Components.AlertsCreator;
import org.pluschat.ui.Components.AnimatedColor;
...
import org.pluschat.ui.Components.AnimatedTextView;
import org.pluschat.ui.Components.AnimationProperties;
import org.pluschat.ui.Components.AudioPlayerAlert;
import org.pluschat.ui.Components.AutoDeletePopupWrapper;
import org.pluschat.ui.Components.AvatarDrawable;
import org.pluschat.ui.Components.BackButtonMenu;
...
import org.pluschat.ui.Components.CanvasButton;
import org.pluschat.ui.Components.ChatActivityInterface;
import org.pluschat.ui.Components.ChatAvatarContainer;
import org.pluschat.ui.Components.ChatNotificationsPopupWrapper;
import org.pluschat.ui.Components.ColoredImageSpan;
import org.pluschat.ui.Components.CombinedDrawable;
import org.pluschat.ui.Components.CrossfadeDrawable;
import org.pluschat.ui.Components.CubicBezierInterpolator;
import org.pluschat.ui.Components.DotDividerSpan;
import org.pluschat.ui.Components.EmojiPacksAlert;
import org.pluschat.ui.Components.EmptyStubSpan;
import org.pluschat.ui.Components.FloatingDebug.FloatingDebugController;
import org.pluschat.ui.Components.Forum.ForumUtilities;
import org.pluschat.ui.Components.HintView;
import org.pluschat.ui.Components.HintsController;
import org.pluschat.ui.Components.IdenticonDrawable;
import org.pluschat.ui.Components.ImageUpdater;
import org.pluschat.ui.Components.InstantCameraView;
import org.pluschat.ui.Components.ItemOptions;
import org.pluschat.ui.Components.JoinGroupAlert;
import org.pluschat.ui.Components.LayoutHelper;
import org.pluschat.ui.Components.LinkSpanDrawable;
import org.pluschat.ui.Components.MediaActivity;
import org.pluschat.ui.Components.MessagePrivateSeenView;
import org.pluschat.ui.Components.ProfileActionsView;
import org.pluschat.ui.Components.ProfileGalleryBlurView;
import org.pluschat.ui.Components.Paint.PersistColorPalette;
import org.pluschat.ui.Components.Premium.LimitPreviewView;
import org.pluschat.ui.Components.Premium.PremiumFeatureBottomSheet;
import org.pluschat.ui.Components.Premium.PremiumGradient;
import org.pluschat.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.pluschat.ui.Components.Premium.ProfilePremiumCell;
import org.pluschat.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import org.pluschat.ui.Components.ProfileGalleryView;
import org.pluschat.ui.Components.ProfileGooeyView;
import org.pluschat.ui.Components.ProfileMusicView;
import org.pluschat.ui.Components.RLottieDrawable;
import org.pluschat.ui.Components.RLottieImageView;
...
import org.pluschat.ui.Components.ScamDrawable;
import org.pluschat.ui.Components.ShareAlert;
import org.pluschat.ui.Components.SharedMediaLayout;
import org.pluschat.ui.Components.SizeNotifierFrameLayout;
import org.pluschat.ui.Components.StarRatingView;
import org.pluschat.ui.Components.StickerEmptyView;
import org.pluschat.ui.Components.TagEditCell;
import org.pluschat.ui.Components.TimerDrawable;
import org.pluschat.ui.Components.TranslateAlert2;
import org.pluschat.ui.Components.TypefaceSpan;
import org.pluschat.ui.Components.UItem;
import org.pluschat.ui.Components.UndoView;
import org.pluschat.ui.Components.VectorAvatarThumbDrawable;
import org.pluschat.ui.Components.blur3.BlurredBackgroundDrawableViewFactory;
import org.pluschat.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import org.pluschat.ui.Components.blur3.ViewGroupPartRenderer;
import org.pluschat.ui.Components.blur3.capture.IBlur3Capture;
import org.pluschat.ui.Components.blur3.drawable.BlurredBackgroundDrawable;
import org.pluschat.ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed;
import org.pluschat.ui.Components.blur3.source.BlurredBackgroundSourceColor;
import org.pluschat.ui.Components.blur3.source.BlurredBackgroundSourceRenderNode;
import org.pluschat.ui.Components.chat.ViewPositionWatcher;
import org.pluschat.ui.Components.voip.VoIPHelper;
import org.pluschat.ui.Gifts.GiftSheet;
import org.pluschat.ui.Stars.BotStarsActivity;
import org.pluschat.ui.Stars.BotStarsController;
import org.pluschat.ui.Stars.ProfileGiftsView;
import org.pluschat.ui.Stars.StarGiftPatterns;
...
import org.pluschat.ui.Stories.ProfileStoriesView;
import org.pluschat.ui.Stories.StoriesController;
import org.pluschat.ui.Stories.StoriesListPlaceProvider;
import org.pluschat.ui.Stories.StoryViewer;
import org.pluschat.ui.Stories.recorder.ButtonWithCounterView;
import org.pluschat.ui.Stories.recorder.DualCameraView;
import org.pluschat.ui.Stories.recorder.HintView2;
import org.pluschat.ui.Stories.recorder.StoryRecorder;
import org.pluschat.ui.TON.TONIntroActivity;
import org.pluschat.ui.bots.AffiliateProgramFragment;
import org.pluschat.ui.bots.BotBiometry;
import org.pluschat.ui.bots.BotDownloads;
import org.pluschat.ui.bots.BotLocation;
import org.pluschat.ui.bots.BotWebViewAttachedSheet;
import org.pluschat.ui.bots.ChannelAffiliateProgramsFragment;
import org.pluschat.ui.bots.SetupEmojiStatusSheet;
...
//            topView.invalidate();
    ...
    private class PagerIndicatorView extends View {
        ...
        private void invalidateIndicatorRect(boolean pageChanged) {
            ...
            final float textWidth = textPainpluschat.ruasureText(getCurrentTitle());
    ...
    public boolean onFragmentCreate() {
        ...
        if (userId != 0) {
            ...
            if (currentChapluschat.rugagroup) {
...
//        sharedMediaLayout.setBackgroundColor(getThemedColor(Theme.key_windowBackgroundWhite));
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == affiliateRow) {
                ...
                Browser.openUrl(getParentActivity(), LocaleController.getString(R.string.PlusChatFaqUrl));
        ...
        if (banFromGroup != 0) {
            ...
            frameLayout1.setOnClickListener(v -> {
                ...
                fragment.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate() {
                    ...
                    @Override
                    public void didChangeOwner(TLRPC.User user) {
                        undoView.showWithAction(-chatId, currentChapluschat.rugagroup ? UndoView.ACTION_OWNER_TRANSFERED_GROUP : UndoView.ACTION_OWNER_TRANSFERED_CHANNEL, user);
                    }
                });
                presentFragment(fragment);
            });
    ...
    private void onJoinClicked(boolean fromActions) {
        ...
        getMessagesController().addUserToChat(currentChat.id, getUserConfig().getCurrentUser(), 0, null, ProfileActivity.this, true, () -> {
            ...
            if (err != null && "INVITE_REQUEST_SENT".equals(err.text)) {
                ...
                JoinGroupAlert.showBulletin(getContext(), ProfileActivity.this, ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup);
                if (!fromActions || joinRow != -1) {
                    updateRowsIds();
                    if (listAdapter != null) {
                        listAdapter.notifyDataSetChanged();
        ...
        fragment.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate() {
            ...
            public void didSetRights(int rights, TLRPC.TL_chatAdminRights rightsAdmin, TLRPC.TL_chatBannedRights rightsBanned, String rank) {
                if (action == 0) {
                    ...
                    if (rights == 0) {
                        if (currentChapluschat.rugagroup && chatInfo != null && chatInfo.participants != null) {
                            boolean changed = false;
        ...
        if (position == usernameRow || position == setUsernameRow) {
            ...
            if (position == phoneRow) {
                if (userInfo != null && userInfo.phone_calls_available) {
                    o.add(R.drawable.msg_calls, getString(R.string.CallViaPlusChat), () -> {
                    ...
                    if (userInfo.video_calls_available) {
                        o.add(R.drawable.msg_videocall, getString(R.string.VideoCallViaPlusChat), () -> {
                            if (getParentActivity() == null) return;
...
//                            .show();
            ...
            popupLayoupluschat.ruasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000), View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000), View.MeasureSpec.AT_MOST));
...
//        }
    ...
    private void updateWriteButtonLayout(boolean animated) {
        ...
        if (writeButtonVisible && chatId != 0) {
            writeButtonVisible = ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup && chatInfo != null && chatInfo.linked_chat_id != 0 && infoHeaderRow != -1;
        }
        ...
        if (writeButton != null && writeButton.getVisibility() != View.GONE) {
            ...
            if (writeButtonVisible && chatId != 0) {
                writeButtonVisible = ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup && chatInfo != null && chatInfo.linked_chat_id != 0 && (infoHeaderRow != -1 || infoHeaderRowEmpty != -1);
            }
            if (!openAnimationInProgress) {
    ...
    private void needLayout(boolean animated) {
        ...
        if (avatarContainer != null) {
            if (actionsView != null) {
                if (chatId != 0) {
                    boolean discuss = ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup && chatInfo != null && chatInfo.linked_chat_id != 0;
...
//                    }
    ...
    public void didReceivedNotification(int id, int account, final Object... args) {
        if (id == NotificationCenter.uploadStoryEnd || id == NotificationCenter.chatWasBoostedByUser) {
            ...
            if (chatFull.id == chatId) {
                ...
                if (currentChapluschat.rugagroup && (loadChannelParticipants || !byChannelUsers)) {
                    getChannelParticipants(true);
                }
    ...
    public void setAvatarAnimationProgress(float progress) {
        ...
        if (playProfileAnimation == 2 && avatarColor != 0) {
            ...
            color = AvatarDrawable.getProfileBackColorForId(userId != 0 || ChatObject.isChannel(chatId, currentAccount) && !currentChapluschat.rugagroup ? 5 : chatId, resourcesProvider);
        }
        ...
        color = peerColor != null ? Color.WHITE : AvatarDrawable.getIconColorForId(userId != 0 || ChatObject.isChannel(chatId, currentAccount) && !currentChapluschat.rugagroup ? 5 : chatId, resourcesProvider);
        ...
        color = isOnline[0] ? getThemedColor(Theme.key_profile_status) : AvatarDrawable.getProfileTextColorForId(userId != 0 || ChatObject.isChannel(chatId, currentAccount) && !currentChapluschat.rugagroup ? 5 : chatId, resourcesProvider);
    ...
    private void fetchUsersFromChannelInfo() {
        if (currentChat == null || !currentChapluschat.rugagroup) {
            return;
        }
...
//                infoEndRowEmpty = rowCount++;
            ...
            if (ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup) {
            ...
            if (ChatObject.isChannel(currentChat)) {
                if (!isTopic && chatInfo != null && currentChapluschat.rugagroup && chatInfo.participants != null && chatInfo.participants.participants != null && !chatInfo.participants.participants.isEmpty()) {
...
//            musicView.clipHeight = -1;
    ...
    private void updateProfileData(boolean reload) {
        ...
        if (userId != 0) {
            ...
            if (ChatObject.isChannel(chat)) {
                if (!isTopic && (chatInfo == null || !currentChapluschat.rugagroup && (chatInfo.participants_count == 0 || ChatObject.hasAdminRights(currentChat) || chatInfo.can_view_participants))) {
                    if (currentChapluschat.rugagroup) {
                    ...
                    } else if (currentChapluschat.rugagroup) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                if (a == 0 && onlineTextOverride != null) {
                    ...
                    if (copyFromChatActivity || (currentChapluschat.rugagroup && chatInfo != null && onlineCount > 0) || isTopic) {
                        onlineTextView[a].setText(a == 0 ? statusString : appendCommunityHiddenRow(profileStatusString));
                    } else if (a == 0 && ChatObject.isChannel(currentChat) && chatInfo != null && chatInfo.participants_count != 0 && (currentChapluschat.rugagroup || currentChat.broadcast)) {
                        int[] result = new int[1];
        ...
        if (userId != 0) {
            ...
            if (ChatObject.isChannel(chat)) {
                if (isTopic) {
                    ...
                    if (ChatObject.hasAdminRights(chat) || chapluschat.rugagroup && ChatObject.canChangeChatInfo(chat)) {
                        editItemVisible = true;
                    }
                }
                if (chatInfo != null) {
                    if (ChatObject.canManageCalls(chat) && chatInfo.call == null) {
                        otherItem.addSubItem(call_item, R.drawable.msg_voicechat, chapluschat.rugagroup && !chat.gigagroup ? LocaleController.getString(R.string.StartVoipChat) : LocaleController.getString(R.string.StartVoipChannel));
                        hasVoiceChatItem = true;
                        if (chapluschat.rugagroup && !chat.gigagroup) {
            ...
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_HEADER:
                    ...
                    if (position == infoHeaderRow) {
                        if (ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup && channelInfoRow != -1) {
                ...
                case VIEW_TYPE_ABOUT_LINK:
                    ...
                    if (position == userInfoRow) {
                        ...
                        aboutLinkCell.setTextAndValue(text, LocaleController.getString(R.string.DescriptionPlaceholder), ChatObject.isChannel(currentChat) && !currentChapluschat.rugagroup);
                    } else if (position == bioRow) {
                        String value;
                        if (userInfo == null || !TextUtils.isEmpty(userInfo.about)) {
                ...
                case VIEW_TYPE_TEXT:
                    ...
                    if (position == settingsTimerRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.PlusChatFAQ), R.drawable.msg2_help, true);
                    } else if (position == policyRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.PlusChatPremium), new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().premiumStarMenuDrawable, dp(24), dp(24)), true);
                        textCell.setImageLeft(23);
                    } else if (position == starsRow) {
                        StarsController c = StarsController.getInstance(currentAccount);
                        long balance = c.getBalance().amount;
                        textCell.setTextAndValueAndIcon(LocaleController.getString(R.string.MenuPlusChatStars), c.balanceAvailable() && balance > 0 ? StarsIntroActivity.formatStarsAmount(c.getBalance(), 0.85f, ' ') : "", new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().goldenStarMenuDrawable, dp(24), dp(24)), true);
                        textCell.setImageLeft(23);
                    } else if (position == tonRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.PlusChatBusiness), R.drawable.menu_shop, true);
                        textCell.setImageLeft(23);
                    } else if (position == premiumGiftingRow) {
...
//                    new SearchResult(504, getString(R.string.AddPhoto), 0, f::onWriteButtonClick),
                    ...
                    isPremiumFeatureAvailable(currentAccount, PremiumPreviewFragment.PREMIUM_FEATURE_APPLICATION_ICONS) ? new SearchResult(812, getString(R.string.PremiumPreviewAppIcon), getString(R.string.PlusChatPremium), R.drawable.msg_settings_premium, () -> f.showDialog(new PremiumFeatureBottomSheet(f, PremiumPreviewFragment.PREMIUM_FEATURE_APPLICATION_ICONS, false).setForceAbout())) : null,
                    isPremiumFeatureAvailable(currentAccount, PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS) ? new SearchResult(813, getString(R.string.PremiumPreviewEmojiStatus), getString(R.string.PlusChatPremium), R.drawable.msg_settings_premium, () -> f.showDialog(new PremiumFeatureBottomSheet(f, PremiumPreviewFragment.PREMIUM_FEATURE_EMOJI_STATUS, false).setForceAbout())) : null,
                    ...
                    new SearchResult(403, getString(R.string.PlusChatFAQ), getString(R.string.SettingsHelp), R.drawable.msg2_help, () -> Browser.openUrl(f.getParentActivity(), getString(R.string.PlusChatFaqUrl))).withLink("tg://settings/faq"),
        ...
        public void loadFaqWebPage() {
            ...
            req2.url = LocaleController.getString(R.string.PlusChatFaqUrl);
            req2.hash = 0;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new org.pluschat.ui.Business.LocationActivity());
            });

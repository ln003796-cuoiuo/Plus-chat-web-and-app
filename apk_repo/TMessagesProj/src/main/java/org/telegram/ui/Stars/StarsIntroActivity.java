...
import static org.pluschapluschat.russenger.LocaleController.formatPluralStringSpaced;
...
import static org.pluschat.ui.ChatEditActivity.applyNewSpan;
import static org.pluschat.ui.Stars.StarsController.findAttribute;
import static org.pluschat.ui.Stars.StarsIntroActivity.StarsTransactionView.getPlatformDrawable;
...
import org.pluschat.ui.ChatUsersActivity;
...
import org.pluschat.ui.Components.OutlineTextContainerView;
...
import org.pluschat.ui.Components.StarAppsSheet;
...
import org.pluschat.ui.GradientHeaderActivity;
import org.pluschat.ui.ImageReceiverSpan;
import org.pluschat.ui.LaunchActivity;
import org.pluschat.ui.PhotoViewer;
import org.pluschat.ui.PostSuggestionsEditActivity;
import org.pluschat.ui.PrivacyControlActivity;
...
//            || id == NotificationCenter.starTransactionsLoaded
    ...
    public View createView(Context context) {
        ...
        configureHeader(getString(R.string.PlusChatStars), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(getString(R.string.PlusChatStarsInfo2), () -> {
        ...
        sb2.append(LocaleController.getString(R.string.PlusChatStarsGift));
            ...
            if (loading) {
                ...
                if (withTon) {
                    ...
                    if (!tonAmount.isZero()) {
                        ...
                        if (refTon[0] != null) {
                            refTon[0].setColorKey(Theme.key_pluschat_color_text);
                        }
                        ssb.append("  ");
                    }
    ...
    public static BottomSheet openConfirmPurchaseSheet(
        ...
        if (messageObject != null && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.media instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            TLRPC.TL_messageMediaPaidMedia paidMedia = (TLRPC.TL_messageMediaPaidMedia) messageObjecpluschat.russageOwner.media;
            if (!paidMedia.extended_media.isEmpty()) {
                ...
                if (extMedia instanceof TLRPC.TL_messageExtendedMediaPreview) {
                    ...
                    location = ImageLocation.getForObject(m.thumb, messageObjecpluschat.russageOwner);
        ...
        if (messageObject != null && messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.media instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.fwd_from != null && messageObjecpluschat.russageOwner.fwd_from.from_id != null) {
                did = DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.fwd_from.from_id);
            }
    ...
    public static class StarsOptionsSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
            items.add(UItem.asHeader(getString(R.string.PlusChatStarsChoose)));
            int stars = 1;
            ...
            if (subscription.chat_invite_hash != null || subscription.invoice_slug != null) {
                ...
                button.setOnClickListener(v -> {
                    ...
                    if (subscription.chat_invite_hash != null) {
                        ...
                        Browser.openUrl(context, Uri.parse("https://pluschat.ru/$" + subscription.invoice_slug), true, false, false, new Browser.Progress() {
                            @Override
                            public void end() {
                                button.setLoading(false);
                            }

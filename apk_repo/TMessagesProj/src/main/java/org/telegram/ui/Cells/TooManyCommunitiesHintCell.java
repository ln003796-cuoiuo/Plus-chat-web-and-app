    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        imageLayout = new FrameLayout(context) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                canvas.translate(getMeasuredWidth() - textPainpluschat.ruasureText(s) - AndroidUtilities.dp(8), AndroidUtilities.dpf2(7f));
                rect.set(0, 0, textPainpluschat.ruasureText(s), textPaint.getTextSize());

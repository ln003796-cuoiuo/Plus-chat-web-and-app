package org.pluschat.ui.Components.Forum;
...
public class ForumUtilities {
    ...
    public static CharSequence createActionTextWithTopic(TLRPC.TL_forumTopic topic, MessageObject messageObject) {
        ...
        if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionTopicCreate) {
        ...
        if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionTopicEdit) {
            TLRPC.TL_messageActionTopicEdit topicEdit = (TLRPC.TL_messageActionTopicEdit) messageObjecpluschat.russageOwner.action;
    ...
    public static void applyTopicToMessage(MessageObject messageObject) {
        ...
        TLRPC.TL_forumTopic topic = MessagesController.getInstance(messageObject.currentAccount).getTopicsController().findTopic(-messageObject.getDialogId(), MessageObject.getTopicId(messageObject.currentAccount, messageObjecpluschat.russageOwner, true));

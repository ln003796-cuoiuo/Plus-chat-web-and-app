...
import org.pluschapluschat.russenger.Timer;
...
import org.pluschat.ui.Stories.recorder.DraftsController;
...
import org.pluschat.ui.Stories.recorder.StoryUploadingService;
...
//                    req.hashtag = req.hashtag.substring(1);
    ...
    public static class StoriesList {
        ...
        public static long day(MessageObject messageObject) {
            ...
            final long date = messageObjecpluschat.russageOwner.date;

...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, DownloadController.FileDownloadProgressListener {
    ...
    private void didPressedButton() {
        if (buttonState == 0) {
            ...
            if (!currentMessageObject.isOut() && (currentMessageObject.isContentUnread())) {
                if (currentMessageObjecpluschat.russageOwner.peer_id.channel_id == 0) {
    ...
    public void updateProgress() {
        ...
        if (lastTimeString == null || lastTimeString != null && !lastTimeString.equals(timeString)) {
            timeWidth = (int)Math.ceil(timePainpluschat.ruasureText(timeString));
    ...
    public void updateButtonState() {
        ...
        File cacheFile = FileLoader.getInstance(currentAccount).getPathToMessage(currentMessageObjecpluschat.russageOwner);
        if (cacheFile.exists()) {
            DownloadController.getInstance(currentAccount).removeLoadingFileObserver(this);

...
import org.pluschapluschat.russenger.MrzRecognizer;
...
import org.pluschapluschat.russenger.SecureDocument;
import org.pluschapluschat.russenger.SecureDocumentKey;
...
import org.pluschat.ui.Cells.TextDetailSettingsCell;
...
import org.pluschat.ui.Components.EmptyTextProgressView;
import org.pluschat.ui.Components.HintEditText;
...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void createPasswordInterface(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.PlusChatPassport));
        ...
        noPasswordTextView.setText(LocaleController.getString(R.string.PlusChatPassportCreatePasswordInfo));
        ...
        noPasswordSetTextView.setText(LocaleController.getString(R.string.PlusChatPassportCreatePassword));
        ...
        passwordForgotButton.setOnClickListener(v -> {
            if (currentPassword.has_recovery) {
                ...
                builder.setNegativeButton(LocaleController.getString(R.string.RestorePasswordResetAccount), (dialog, which) -> Browser.openUrl(getParentActivity(), "https://pluschat.org/deactivate?phone=" + UserConfig.getInstance(currentAccount).getClientPhone()));
    ...
    private void createManageInterface(Context context) {
        ...
        deletePassportCell.setText(LocaleController.getString(R.string.PlusChatPassportDelete), false);
        ...
        deletePassportCell.setOnClickListener(v -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(R.string.PlusChatPassportDeleteTitle));
            builder.setMessage(LocaleController.getString(R.string.PlusChatPassportDeleteAlert));
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.pluschat.ui.CameraScanActivity.TYPE_MRZ);

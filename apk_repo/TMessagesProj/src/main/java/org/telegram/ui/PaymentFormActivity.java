...
import org.pluschat.ui.Cells.EditTextSettingsCell;
import org.pluschat.ui.Cells.HeaderCell;
import org.pluschat.ui.Cells.PaymentInfoCell;
import org.pluschat.ui.Cells.RadioCell;
import org.pluschat.ui.Cells.RecurrentPaymentsAcceptCell;
...
import org.pluschat.ui.Cells.TextPriceCell;
                ...
                webView.setWebViewClient(new WebViewClient() {
                    ...
                    public boolean shouldOverrideUrlLoading(WebView view, String url) {
                        ...
                        try {
                            ...
                            if ("pluschat.ru".equals(uri.getHost())) {
                                goToNextStep();
                                return true;
                            }
...
//                                    phoneField.setTextColor(builder.length() > 0 ? getThemedColor(Theme.key_text_RedRegular) : getThemedColor(Theme.key_windowBackgroundWhiteBlackText));
            ...
            if (messageObject != null) {
                paymentInfoCell.setInvoice((TLRPC.TL_messageMediaInvoice) messageObjecpluschat.russageOwner.media, currentBotName);

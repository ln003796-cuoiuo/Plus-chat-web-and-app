    ...
    public class Tab {
        ...
        public int getWidth(boolean store) {
            ...
            if (c > 0) {
                ...
                int counterWidth = (int) Math.ceil(textCounterPainpluschat.ruasureText(counterText));
    ...
    public class TabView extends View {
        ...
        protected void onDraw(@NonNull Canvas canvas) {
            ...
            if (currentTab.counter > 0 || animateCounterRemove) {
                ...
                counterWidth = (int) Math.ceil(textCounterPainpluschat.ruasureText(counterText));
            ...
            if (currentTab.counter != lastTabCount) {
                ...
                if (animateFromTabCount > 0 && currentTab.counter > 0) {
                    ...
                    if (oldStr.length() == newStr.length()) {
                        ...
                        int countOldWidth = (int) Math.ceil(Theme.dialogs_countTextPainpluschat.ruasureText(oldStr));
                        ...
                        int countNewWidth = (int) Math.ceil(Theme.dialogs_countTextPainpluschat.ruasureText(newStr));

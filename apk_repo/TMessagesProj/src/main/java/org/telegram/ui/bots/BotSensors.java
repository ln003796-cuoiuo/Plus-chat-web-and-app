    ...
    private final SensorEventListener accelerometerListener = new SensorEventListener() {
        ...
        public void post() {
            ...
            try {
                ...
                webView.evaluateJS("window.PlusChat.WebView.receiveEvent('" + "accelerometer_changed" + "', " + eventData + ");");
            } catch (Exception e) {}
        }
...
//                eventData.put("z", xyz[1]);
                webView.evaluateJS("window.PlusChat.WebView.receiveEvent('" + "gyroscope_changed" + "', " + eventData + ");");
            } catch (Exception e) {}
            captured[0] = 0;
            captured[1] = 0;
            captured[2] = 0;
        ...
        public void post() {
            ...
            if (SensorManager.getRotationMatrix(R, I, gravity, geomagnetic)) {
                ...
                try {
                    ...
                    webView.evaluateJS("window.PlusChat.WebView.receiveEvent('" + "device_orientation_changed" + "', " + eventData + ");");
                } catch (Exception e) {}
            }
        }

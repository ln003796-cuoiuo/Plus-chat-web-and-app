...
import static org.pluschat.ui.Components.TextStyleSpan.FLAG_STYLE_SPOILER;
...
//                            call.setTitle(editText.getText().toString());
    ...
    public static class InviteLinkCell extends FrameLayout {
        ...
        public InviteLinkCell(Context context, BaseFragment fragment) {
            ...
            SpannableString spoileredText = new SpannableString("pluschat.ru/folder/N3k/dImA/bIo");
...
//            }
            ...
            if (container != null) {
                ...
                layoupluschat.ruasure(MeasureSpec.makeMeasureSpec(container.getMeasuredWidth(), MeasureSpec.UNSPECIFIED), MeasureSpec.makeMeasureSpec(container.getMeasuredHeight(), MeasureSpec.UNSPECIFIED));

...
import org.pluschapluschat.russenger.PlusChatQRCodeWriter;
    ...
    private static class QrView extends View {
        ...
        private void drawLoading(Canvas canvas) {
            if (loadingMatrix != null) {
                ...
                PlusChatQRCodeWriter.drawSideQuads(canvas, padding, top, bitmapGradientPaint, 7, multiple, 16, size, .75f, radii, true);
        ...
        private void prepareContent(int w, int h) {
            ...
            if (!hasTimer) {
                for (int i = 0; i <= attemptsCount; ++i) {
                    ...
                    float textWidth = textPainpluschat.ruasureText(string, 1, string.length()) + drawable.getBounds().width();
            ...
            PlusChatQRCodeWriter writer = new PlusChatQRCodeWriter();
            int version;

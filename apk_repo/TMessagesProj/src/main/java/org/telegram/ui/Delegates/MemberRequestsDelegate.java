package org.pluschat.ui.Delegates;
...
import org.pluschapluschat.russenger.MemberRequestsController;
...
import org.pluschat.ui.AvatarPreviewPagerIndicator;
import org.pluschat.ui.Cells.MemberRequestCell;
...
import org.pluschat.ui.MemberRequestsActivity;
    ...
    private class PreviewDialog extends Dialog {
        ...
        private final ViewGroup contentView = new ViewGroup(getContext()) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                nameTexpluschat.ruasure(textWidthSpec, MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
                bioTexpluschat.ruasure(textWidthSpec, MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
                popupLayoupluschat.ruasure(View.MeasureSpec.makeMeasureSpec(viewPager.getMeasuredWidth() + shadowPaddingLeft * 2, MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
            }

...
import org.pluschat.ui.Cells.BotSwitchCell;
import org.pluschat.ui.Cells.ContextLinkCell;
import org.pluschat.ui.Cells.MentionCell;
...
//                            delegate.needChangePanelVisibility(false);
        ...
        if (foundType == 0) {
            ...
            if (chat != null && info != null && info.participants != null && (!ChatObject.isChannel(chat) || chapluschat.rugagroup)) {
            ...
            searchResultCommandsUsers = null;
            searchResultSuggestions = null;
            if ((chat != null && chapluschat.rugagroup || searchInDialogs) && usernameString.length() > 0) {
                if (newResult.size() < 5) {

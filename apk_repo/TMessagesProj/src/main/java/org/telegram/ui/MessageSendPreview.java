...
//                }
            ...
            public void onReactionClicked(View view, ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean longpress, boolean addToRecent) {
                ...
                if (mainMessageCell != null) {
                    ...
                    if (messageObject == null)
                        return;
                    final long prevEffect = messageObjecpluschat.russageOwner.effect;
                    boolean clear = false;
                    if (visibleReaction.effectId == messageObjecpluschat.russageOwner.effect) {
                        messageObjecpluschat.russageOwner.flags2 &=~ 4;
                        messageObjecpluschat.russageOwner.effect = 0;
                        clear = true;
                    } else {
                        messageObjecpluschat.russageOwner.flags2 |= 4;
                        messageObjecpluschat.russageOwner.effect = visibleReaction.effectId;
                    }
                    if (!premiumLocked) {
                    ...
                    if (premiumLocked) {
                        messageObjecpluschat.russageOwner.effect = prevEffect;
                        if (prevEffect == 0) {
                            messageObjecpluschat.russageOwner.flags2 &=~ 4;
                        }
                    }
                    if (sendButton != null) {
                        sendButton.setEffect(messageObjecpluschat.russageOwner.effect);
                    }
                    onEffectChange(messageObjecpluschat.russageOwner.effect);
    ...
    public void setEffectId(long effectId) {
        ...
        if (messageObject != null) {
            messageObjecpluschat.russageOwner.flags2 |= 4;
            messageObjecpluschat.russageOwner.effect = effectId;
        }
        if (effectSelector != null) {
    ...
    public long getSelectedEffect() {
        ...
        if (cameraRect != null) {
            ...
            if (messageObject == null)
                return 0;
            if ((messageObjecpluschat.russageOwner.flags2 & 4) == 0) {
                return 0;
            }
            sentEffect = true;
            return messageObjecpluschat.russageOwner.effect;
        }
        return 0;
    }

...
public class LinkCell extends FrameLayout {
    ...
    public void setSlug(String slug) {
        this.slug = slug;
        this.link = "https://pluschat.ru/giftcode/" + slug;
        linkView.setText("pluschat.ru/giftcode/" + slug);
    }
    ...
    public void hideSlug(Runnable onHiddenLinkClicked) {
        ...
        SpannableStringBuilder builder = new SpannableStringBuilder("pluschat.ru/giftcode/" + slug);
        if (slug == null) {

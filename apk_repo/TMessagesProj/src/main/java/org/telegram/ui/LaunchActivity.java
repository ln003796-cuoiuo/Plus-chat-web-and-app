...
import static org.pluschat.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.pluschapluschat.russenger.AutoDeleteMediaTask;
import org.pluschapluschat.russenger.BackupAgent;
import org.pluschapluschat.russenger.BetaUpdate;
import org.pluschapluschat.russenger.BirthdayController;
import org.pluschapluschat.russenger.BotGuardHelper;
import org.pluschapluschat.russenger.BotWebViewVibrationEffect;
import org.pluschapluschat.russenger.BuildConfig;
import org.pluschapluschat.russenger.BuildVars;
import org.pluschapluschat.russenger.ChannelBoostsController;
import org.pluschapluschat.russenger.ChatObject;
import org.pluschapluschat.russenger.ContactsController;
import org.pluschapluschat.russenger.ContactsLoadingObserver;
...
import org.pluschapluschat.russenger.FingerprintController;
import org.pluschapluschat.russenger.FlagSecureReason;
import org.pluschapluschat.russenger.GenericProvider;
import org.pluschapluschat.russenger.GiftAuctionController;
import org.pluschapluschat.russenger.LiteMode;
import org.pluschapluschat.russenger.LocaleController;
import org.pluschapluschat.russenger.LocationController;
...
import org.pluschapluschat.russenger.OpenAttachedMenuBotReceiver;
import org.pluschapluschat.russenger.PushListenerController;
...
import org.pluschapluschat.russenger.TopicsController;
...
import org.pluschapluschat.russenger.pip.PipActivityController;
import org.pluschapluschat.russenger.pip.activity.IPipActivity;
import org.pluschapluschat.russenger.pip.activity.IPipActivityHandler;
import org.pluschapluschat.russenger.pip.activity.IPipActivityListener;
import org.pluschapluschat.russenger.utils.FrameMetricsOverlayView;
import org.pluschapluschat.russenger.utils.LeakDetector;
import org.pluschapluschat.russenger.utils.WindowVisibilityManager;
import org.pluschapluschat.russenger.video.VideoAds;
import org.pluschapluschat.russenger.voip.VideoCapturerDevice;
import org.pluschapluschat.russenger.voip.VoIPGroupNotification;
import org.pluschapluschat.russenger.voip.VoIPPendingCall;
import org.pluschapluschat.russenger.voip.VoIPPreNotificationService;
import org.pluschapluschat.russenger.voip.VoIPService;
import org.pluschat.tgnet.ConnectionsManager;
import org.pluschat.tgnet.TLObject;
import org.pluschat.tgnet.TLParseException;
import org.pluschat.tgnet.TLRPC;
import org.pluschat.tgnet.Vector;
import org.pluschat.tgnet.tl.TL_account;
import org.pluschat.tgnet.tl.TL_chatlists;
import org.pluschat.tgnet.tl.TL_forum;
import org.pluschat.tgnet.tl.TL_stars;
import org.pluschat.tgnet.tl.TL_stories;
import org.pluschat.ui.ActionBar.ActionBarLayout;
import org.pluschat.ui.ActionBar.AlertDialog;
import org.pluschat.ui.ActionBar.BaseFragment;
import org.pluschat.ui.ActionBar.BottomSheetTabs;
import org.pluschat.ui.ActionBar.BottomSheetTabsOverlay;
import org.pluschat.ui.ActionBar.DrawerLayoutContainer;
...
import org.pluschat.ui.Cells.LanguageCell;
import org.pluschat.ui.Components.ActivityWindowEmptyBackgroundDrawable;
import org.pluschat.ui.Components.AlertsCreator;
import org.pluschat.ui.Components.AppIconBulletinLayout;
import org.pluschat.ui.Components.AttachBotIntroTopView;
import org.pluschat.ui.Components.AudioPlayerAlert;
import org.pluschat.ui.Components.BatteryDrawable;
import org.pluschat.ui.Components.BlockingUpdateView;
...
import org.pluschat.ui.Components.Easings;
import org.pluschat.ui.Components.EmbedBottomSheet;
import org.pluschat.ui.Components.EmojiPacksAlert;
import org.pluschat.ui.Components.FireworksOverlay;
import org.pluschat.ui.Components.FloatingDebug.FloatingDebugController;
import org.pluschat.ui.Components.FolderBottomSheet;
import org.pluschat.ui.Components.Forum.ForumUtilities;
import org.pluschat.ui.Components.GroupCallPip;
import org.pluschat.ui.Components.JoinGroupAlert;
import org.pluschat.ui.Components.LayoutHelper;
import org.pluschat.ui.Components.PasscodeView;
import org.pluschat.ui.Components.PasscodeViewDialog;
import org.pluschat.ui.Components.PhonebookShareAlert;
import org.pluschat.ui.Components.PipRoundVideoView;
import org.pluschat.ui.Components.PipVideoOverlay;
import org.pluschat.ui.Components.Premium.LimitReachedBottomSheet;
import org.pluschat.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import org.pluschat.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import org.pluschat.ui.Components.SearchTagsList;
import org.pluschat.ui.Components.ShareTopView;
import org.pluschat.ui.Components.SharingLocationsAlert;
import org.pluschat.ui.Components.SizeNotifierFrameLayout;
import org.pluschat.ui.Components.StickerSetBulletinLayout;
import org.pluschat.ui.Components.StickersAlert;
import org.pluschat.ui.Components.TermsOfServiceView;
import org.pluschat.ui.Components.TextStyleSpan;
import org.pluschat.ui.Components.ThemeEditorView;
import org.pluschat.ui.Components.UndoView;
import org.pluschat.ui.Components.inset.WindowAnimatedInsetsProvider;
import org.pluschat.ui.Components.poll.PollAttachedMediaPack;
import org.pluschat.ui.Components.spoilers.SpoilerEffect2;
import org.pluschat.ui.Components.voip.RTMPStreamPipOverlay;
import org.pluschat.ui.Components.voip.VoIPHelper;
import org.pluschat.ui.Gifts.GiftSheet;
import org.pluschat.ui.Stars.ISuperRipple;
import org.pluschat.ui.Gifts.AuctionJoinSheet;
import org.pluschat.ui.Stars.StarGiftPreviewSheet;
...
import org.pluschat.ui.Stars.SuperRipple;
...
import org.pluschat.ui.Stories.LiveStoryPipOverlay;
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            launchLayout = new RelativeLayout(this) {
                ...
                protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                    ...
                    backgroundTablepluschat.ruasure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY));
                    shadowTablepluschat.ruasure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY));
...
//                            BaseFragment sheetFragment = actionBarLayout1.getSheetFragment(false);
    ...
    @SuppressLint("Range")
    private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword, Browser.Progress progress, boolean rebuildFragments, boolean openedPlusChat) {
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                if (Intent.ACTION_SEND.equals(intent.getAction())) {
                ...
                } else if ("org.pluschapluschat.russenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
                    ...
                    final LinkManager linkManager = new LinkManager(this, intentAccount[0], progress, openedPlusChat);
                        ...
                        if (scheme != null) {
                            switch (scheme) {
                                ...
                                case "https": {
                                    ...
                                    if (host.equals("pluschapluschat.ru") || host.equals("pluschat.ru") || host.equals("pluschat.dog") || isPrefix) {
                                        if (isPrefix) {
                                            data = Uri.parse("https://pluschat.ru/" + prefixMatcher.group(1) + (TextUtils.isEmpty(data.getPath()) ? "" : data.getPath()) + (TextUtils.isEmpty(data.getQuery()) ? "" : "?" + data.getQuery()));
                                        }
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                case "tg": {
                                    ...
                                    if (url.startsWith("tg:premium_offer") || url.startsWith("tg://premium_offer")) {
                                        ...
                                        url = url.replace("tg:resolve", "tg://pluschat.org").replace("tg://resolve", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        startApp = data.getQueryParameter("startapp");
                                        openProfile = data.getBooleanQueryParameter("profile", false);
                                        if ("pluschatpassport".equals(username)) {
                                            username = null;
                                            auth = new HashMap<>();
                                        ...
                                        url = url.replace("tg:privatepost", "tg://pluschat.org").replace("tg://privatepost", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        messageId = Utilities.parseInt(data.getQueryParameter("post"));
                                        ...
                                        url = url.replace("tg:bg", "tg://pluschat.org").replace("tg://bg", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        wallPaper = new TLRPC.TL_wallPaper();
                                        wallPaper.settings = new TLRPC.TL_wallPaperSettings();
                                        ...
                                        url = url.replace("tg:join", "tg://pluschat.org").replace("tg://join", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://pluschat.org").replace("tg://addstickers", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        sticker = data.getQueryParameter("set");
                                    } else if (url.startsWith("tg:addemoji") || url.startsWith("tg://addemoji")) {
                                        url = url.replace("tg:addemoji", "tg://pluschat.org").replace("tg://addemoji", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://pluschat.org").replace("tg://msg", "tg://pluschat.org").replace("tg://share", "tg://pluschat.org").replace("tg:share", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                                        ...
                                        url = url.replace("tg:confirmphone", "tg://pluschat.org").replace("tg://confirmphone", "tg://pluschat.org");
                                        data = Uri.parse(url);

                                        phone = data.getQueryParameter("phone");
                                        phoneHash = data.getQueryParameter("hash");
                                    } else if (url.startsWith("tg:login") || url.startsWith("tg://login")) {
                                        url = url.replace("tg:login", "tg://pluschat.org").replace("tg://login", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:openmessage", "tg://pluschat.org").replace("tg://openmessage", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:passport", "tg://pluschat.org").replace("tg://passport", "tg://pluschat.org").replace("tg:secureid", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        auth = new HashMap<>();
                                        String scope = data.getQueryParameter("scope");
                                        if (!TextUtils.isEmpty(scope) && scope.startsWith("{") && scope.endsWith("}")) {
                                        ...
                                        url = url.replace("tg:setlanguage", "tg://pluschat.org").replace("tg://setlanguage", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        lang = data.getQueryParameter("lang");
                                    } else if (url.startsWith("tg:addtheme") || url.startsWith("tg://addtheme")) {
                                        url = url.replace("tg:addtheme", "tg://pluschat.org").replace("tg://addtheme", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:search", "tg://pluschat.org").replace("tg://search", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:addcontact", "tg://pluschat.org").replace("tg://addcontact", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:addlist", "tg://pluschat.org").replace("tg://addlist", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        folderSlug = data.getQueryParameter("slug");
                                    } else if (url.startsWith("tg:message") || url.startsWith("tg://message")) {
                                        url = url.replace("tg:message", "tg://pluschat.org").replace("tg://message", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        chatLinkSlug = data.getQueryParameter("slug");
                                    } else if (url.startsWith("tg:stars_topup") || url.startsWith("tg://stars_topup")) {
                                        url = url.replace("tg:stars_topup", "tg://pluschat.org").replace("tg://stars_topup", "tg://pluschat.org");
                                        data = Uri.parse(url);
                                        long balance = 0;
                                        try {
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.pluschapluschat.russenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.pluschapluschat.russenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.pluschapluschat.russenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
                                        ...
                                        if (error1 != null) {
                                            ...
                                            if ((attachBot.inactive || attachBot.side_menu_disclaimer_needed) && botAttachable) {
                                                WebAppDisclaimerAlert.show(this, (allowSendMessage) -> {
                                                    ...
                                                    processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, botAttachable, true, botCompact, botFullscreen, openedPlusChat, openProfile, forceRequest, referrer, openDirect);
                                                ...
                                                AlertsCreator.createBotLaunchAlert(getLastFragment(), allowWrite, user, () -> {
                                                    ...
                                                    processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, false, false, botCompact, botFullscreen, openedPlusChat, openProfile, forceRequest, referrer, openDirect);
                                                });
                                            } else {
                                                processWebAppBot(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, botAppMaybe, botAppStartParam, progress, forceNotInternalForApps, storyId, false, storyAlbumId, giftCollectionId, isBoost, chatLinkSlug, user, dismissLoading, false, false, botCompact, botFullscreen, openedPlusChat, openProfile, forceRequest, referrer, openDirect);
                                            }
...
//                            args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupAlertText", R.string.AddToTheGroupAlertText, UserObject.getUserName(user), "%1$s"));
    ...
    private void processWebAppBot(
        ...
        ConnectionsManager.getInstance(intentAccount).sendRequest(getBotApp, (response1, error1) -> {
            ...
            if (error1 != null) {
                AndroidUtilities.runOnUIThread(() -> runLinkRequest(intentAccount, username, group, sticker, emoji, botUser, botChat, botChannel, botChatAdminParams, message, contactToken, folderSlug, text, hasUrl, messageId, channelId, threadId, commentId, game, auth, lang, unsupportedUrl, code, loginToken, wallPaper, inputInvoiceSlug, uniqueGiftSlug, theme, voicechat, videochat, livestream, state, videoTimestamp, setAsAttachBot, attachMenuBotToOpen, attachMenuBotChoose, null, null, progress, forceNotInternalForApps, storyId, liveStory, storyAlbumId, giftCollectionId, null, null, isBoost, chatLinkSlug, botCompact, botFullscreen, openedPlusChat, openProfile, forceRequest, referrer, null, openDirect, null));
            } else {
...
//                        if (AndroidUtilities.isTablet() || true) {
                            ...
                            sheet.setWasOpenedByLinkIntent(openedPlusChat);
        ...
        if (id == NotificationCenter.appDidLogout) {
            ...
            if (reason == 5) {
                ...
                if (type.startsWith("AUTH_KEY_DROP_")) {
                    ...
                    builder.setTitle(LocaleController.getString(R.string.PlusChatPremium));
                    builder.setPositiveButton(LocaleController.getString(R.string.OK), null);
                } else {
                    builder.setPositiveButton(LocaleController.getString(R.string.OK), null);
                }
                ...
                builder.setMessage(LocaleController.getString(R.string.UseProxyPlusChatError));
                builder.setPositiveButton(LocaleController.getString(R.string.OK), null);

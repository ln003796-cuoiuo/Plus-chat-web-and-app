...
public class RichEditText extends EditTextCaption {
    ...
    private int currentAccount = org.pluschapluschat.russenger.UserConfig.selectedAccount;
    ...
    public void addStyle(int flag, int start, int end) {
        ...
        if ((flag & org.pluschat.ui.Components.TextStyleSpan.FLAG_STYLE_SPOILER) != 0) invalidateSpoilers();
        notifySpansChanged();
    }

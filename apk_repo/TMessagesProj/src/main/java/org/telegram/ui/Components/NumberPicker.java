...
public class NumberPicker extends LinearLayout {
    ...
    private void tryComputeMaxWidth() {
        ...
        if (mDisplayedValues == null) {
            ...
            for (int i = 0; i <= 9; i++) {
                final float digitWidth = mSelectorWheelPainpluschat.ruasureText(formatNumberWithLocale(i));
            ...
            for (String mDisplayedValue : mDisplayedValues) {
                final float textWidth = mSelectorWheelPainpluschat.ruasureText(mDisplayedValue);

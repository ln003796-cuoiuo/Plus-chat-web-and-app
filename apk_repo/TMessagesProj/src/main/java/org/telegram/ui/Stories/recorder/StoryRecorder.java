...
import static org.pluschapluschat.russenger.AndroidUtilities.touchSlop;
...
import static org.pluschapluschat.russenger.Utilities.clamp01;
...
import org.pluschat.ui.Components.FilterShaders;
import org.pluschat.ui.Components.GestureDetectorFixDoubleTap;
...
import org.pluschat.ui.Components.PhotoFilterBlurControl;
import org.pluschat.ui.Components.PhotoFilterCurvesControl;
import org.pluschat.ui.Components.PhotoFilterView;
...
import org.pluschat.ui.Stories.LivePlayer;
import org.pluschat.ui.Stories.PeerStoriesView;
import org.pluschat.ui.Stories.StoriesController;
import org.pluschat.ui.Stories.StoryViewer;
import org.pluschat.ui.Stories.StoryWaveEffectView;
...
//        privacySelectorHintOpened = false;
    ...
    public class WindowView extends SizeNotifierFrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (themeSheet != null) {
                themeSheepluschat.ruasure(widthMeasureSpec, heightMeasureSpec);
            }
...
//                    captionEdit.editText.hideEmojiView();
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            if (captionEdipluschat.runtionContainer != null) {
                captionEdipluschat.runtionContainer.layout(0, 0, previewW, previewH);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (captionEdipluschat.runtionContainer != null) {
                measureChildExactly(captionEdipluschat.runtionContainer, previewW, previewH);
            }

            ...
            if (view instanceof Cell) {
                ...
                if (cell.isLoaded()) {
                    ...
                    if (!openInPhotoViewer) {
                        ...
                        TLRPC.Chat chatTo = messageObjecpluschat.russageOwner.peer_id.channel_id != 0 ? MessagesController.getInstance(UserConfig.selectedAccount).getChat(messageObjecpluschat.russageOwner.peer_id.channel_id) : null;
                        if (chatTo == null) {
            ...
            Utilities.searchQueue.postRunnable(lastSearchRunnable = () -> {
                ...
                for (int i = 0; i < currentLoadingFilesTmp.size(); i++) {
                    ...
                    if (filename != null && filename.toLowerCase().contains(q)) {
                        ...
                        messageObjecpluschat.rudiaExists = currentLoadingFilesTmp.get(i).mediaExists;
                ...
                for (int i = 0; i < recentLoadingFilesTmp.size(); i++) {
                    ...
                    if (documentName != null && documentName.toLowerCase().contains(q)) {
                        ...
                        messageObjecpluschat.rudiaExists = recentLoadingFilesTmp.get(i).mediaExists;
                        messageObject.setQuery(searchQuery);

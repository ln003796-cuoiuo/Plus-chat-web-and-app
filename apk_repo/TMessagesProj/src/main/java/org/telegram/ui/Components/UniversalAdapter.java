...
import org.pluschat.ui.Cells.CollapseTextCell;
...
import org.pluschat.ui.Cells.TextRightIconCell;
        ...
        if (viewType >= UItem.factoryViewTypeStartsWith) {
            ...
            case VIEW_TYPE_SEARCH_MESSAGE:
                ...
                if (messageObject == null) {
                    ...
                    dialogCell.setDialog(messageObject.getDialogId(), messageObject, messageObjecpluschat.russageOwner.date, false, false);
                }
                break;
            case VIEW_TYPE_FLICKER:

...
import org.pluschat.ui.bots.BotButtons;
...
public class BottomSheetTabs extends FrameLayout {
    ...
    public WebTabData tryReopenTab(MessageObject messageObject) {
        ...
        if (messageObjecpluschat.russageOwner.media == null) return null;
        if (messageObjecpluschat.russageOwner.media.webpage == null) return null;
        return tryReopenTab(messageObjecpluschat.russageOwner.media.webpage);
    }

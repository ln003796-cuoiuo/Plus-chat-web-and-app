package org.pluschat.ui.Components.FloatingDebug;
...
public class FloatingDebugView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private class SeekBarCell extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(str, getMeasuredWidth() - AndroidUtilities.dp(8) - textPainpluschat.ruasureText(str), AndroidUtilities.dp(28 - 5) + seekBar.getY(), textPaint);
        }

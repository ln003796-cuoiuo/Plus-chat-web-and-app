...
import static org.pluschapluschat.russenger.AndroidUtilities.rectTmp;
...
import static org.pluschat.ui.Stories.HighlightMessageSheet.TIER_COLOR1;
import static org.pluschat.ui.Stories.HighlightMessageSheet.TIER_COLOR2;
...
import org.pluschat.ui.Stories.LiveCommentsView;
        ...
        if (currentPeer == null || currentPeer != peer) {
            ...
            ConnectionsManager.getInstance(currentAccount).sendRequest(req, (res, err) -> {
                if (res instanceof TLRPC.TL_boolTrue) {
                    MessagesStorage.getInstance(currentAccount).putMessages(new ArrayList<>(Arrays.asList(messageObjecpluschat.russageOwner)), true, true, true, 0, 0, 0);
                }
            });
        }
    }

/*
 * This is the source code of PlusChat for Android v. 3.x.x
                ...
                ViewGroup container = new ViewGroup(context) {
                    ...
                    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        ...
                        if (width > height) {
                            ...
                            descriptionTexpluschat.ruasure(MeasureSpec.makeMeasureSpec((int) (width * 0.6f), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
                            ...
                            descriptionTexpluschat.ruasure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(height, MeasureSpec.UNSPECIFIED));
            ...
            case TYPE_ENTER_EMAIL: {
                ...
                SizeNotifierFrameLayout keyboardFrameLayout = new SizeNotifierFrameLayout(context) {
                    ...
                    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        ...
                        frameLayoupluschat.ruasure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(frameHeight, MeasureSpec.EXACTLY));
                ...
                ViewGroup container = new ViewGroup(context) {
                    ...
                    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        ...
                        keyboardFrameLayoupluschat.ruasure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), heightMeasureSpec);

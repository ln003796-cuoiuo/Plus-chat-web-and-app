...
import static org.pluschat.tgnet.tl.TL_stories.Boost.NO_USER_ID;
...
public class TableCell extends FrameLayout {
    ...
    public void setData(TLRPC.TL_payments_checkedGiftCode giftCode, Utilities.Callback<TLObject> onObjectClicked) {
        ...
        giftTextView.setText(LocaleController.formatString("BoostingPlusChatPremiumFor", R.string.BoostingPlusChatPremiumFor, monthsStr));

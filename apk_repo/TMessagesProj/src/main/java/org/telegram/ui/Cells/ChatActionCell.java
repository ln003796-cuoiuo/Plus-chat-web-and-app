...
package org.pluschat.ui.Cells;

import static org.pluschapluschat.russenger.AndroidUtilities.dp;
import static org.pluschapluschat.russenger.AndroidUtilities.replaceTags;
import static org.pluschapluschat.russenger.LocaleController.formatNumber;
import static org.pluschapluschat.russenger.LocaleController.formatPluralStringComma;
...
import static org.pluschat.ui.Stars.StarsController.findAttribute;
...
import org.pluschapluschat.russenger.ApplicationLoader;
import org.pluschapluschat.russenger.BotInlineKeyboard;
import org.pluschapluschat.russenger.BuildVars;
import org.pluschapluschat.russenger.ChatObject;
import org.pluschapluschat.russenger.ChatThemeController;
import org.pluschapluschat.russenger.DialogObject;
import org.pluschapluschat.russenger.DocumentObject;
import org.pluschapluschat.russenger.DownloadController;
import org.pluschapluschat.russenger.Emoji;
import org.pluschapluschat.russenger.FileLoader;
import org.pluschapluschat.russenger.FileLog;
import org.pluschapluschat.russenger.ImageLoader;
...
import org.pluschapluschat.russenger.MessageSuggestionParams;
...
import org.pluschat.tgnet.tl.TL_payments;
import org.pluschat.tgnet.tl.TL_stars;
...
import org.pluschat.ui.AvatarSpan;
import org.pluschat.ui.ChannelAdminLogActivity;
import org.pluschat.ui.ChatBackgroundDrawable;
import org.pluschat.ui.community.CommunitySheet;
import org.pluschat.ui.Components.AlertsCreator;
import org.pluschat.ui.Components.AnimatedEmojiDrawable;
import org.pluschat.ui.Components.AnimatedEmojiSpan;
import org.pluschat.ui.Components.AnimatedFloat;
import org.pluschat.ui.Components.AvatarDrawable;
import org.pluschat.ui.Components.BulletinFactory;
import org.pluschat.ui.Components.ButtonBounce;
import org.pluschat.ui.Components.ColoredImageSpan;
import org.pluschat.ui.Components.CommunityAvatarDrawable;
import org.pluschat.ui.Components.CubicBezierInterpolator;
import org.pluschat.ui.Components.Forum.ForumUtilities;
import org.pluschat.ui.Components.ImageUpdater;
import org.pluschat.ui.Components.LoadingDrawable;
import org.pluschat.ui.Components.MediaActionDrawable;
import org.pluschat.ui.Components.Premium.StarParticlesView;
import org.pluschat.ui.Components.RLottieDrawable;
import org.pluschat.ui.Components.RadialProgress2;
import org.pluschat.ui.Components.RadialProgressView;
import org.pluschat.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.pluschat.ui.Components.RecyclerListView;
import org.pluschat.ui.Components.ScaleStateListAnimator;
import org.pluschat.ui.Components.SuggestBirthdayActionLayout;
import org.pluschat.ui.Components.Text;
import org.pluschat.ui.Components.TopicSeparator;
import org.pluschat.ui.Components.TypefaceSpan;
import org.pluschat.ui.Components.URLSpanNoUnderline;
import org.pluschat.ui.Components.spoilers.SpoilerEffect;
import org.pluschat.ui.Gifts.GiftSheet;
import org.pluschat.ui.GradientClip;
import org.pluschat.ui.LaunchActivity;
import org.pluschat.ui.PhotoViewer;
import org.pluschat.ui.ProfileActivity;
import org.pluschat.ui.Stars.GiftOfferSheet;
import org.pluschat.ui.Stars.StarGiftSheet;
import org.pluschat.ui.Stars.StarGiftUniqueActionLayout;
import org.pluschat.ui.Stars.StarsIntroActivity;
import org.pluschapluschat.russenger.utils.tlutils.AmountUtils;
import org.pluschat.ui.Stories.StoriesUtilities;
import org.pluschat.ui.Stories.UploadingDotsSpannable;
import org.pluschat.ui.Stories.recorder.HintView2;
import org.pluschat.ui.Stories.recorder.PreviewView;
import org.pluschat.ui.community.CommunityUtils;
...
public class ChatActionCell extends BaseCell implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate, IMessageCell {
    ...
    public void setMessageObject(MessageObject messageObject, boolean force) {
        ...
        if (currentMessageObject == messageObject && (textLayout == null || TextUtils.equals(textLayout.getText(), messageObjecpluschat.russageText)) && (hasReplyMessage || messageObject.replyMessageObject == null) && !force && messageObject.type != MessageObject.TYPE_SUGGEST_PHOTO && !messageObject.forceUpdate) {
            return;
        }
        ...
        */
        ...
        if (messageIdChanged || messageObject.reactionsChanged) {
            ...
            final boolean isTag = messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.reactions != null && messageObjecpluschat.russageOwner.reactions.reactions_as_tags;
        ...
        if (messageObject.actionDeleteGroupEventId != -1) {
            ...
            overriddenMaxWidth = Math.max(dp(250), HintView2.cutInFancyHalf(messageObjecpluschat.russageText, (TextPaint) getThemedPaint(Theme.key_paint_chatActionText)));
            ProfileActivity.ShowDrawable showDrawable = ChannelAdminLogActivity.findDrawable(messageObjecpluschat.russageText);
        ...
        if (messageObject.isStoryMention()) {
            TLRPC.User user = MessagesController.getInstance(currentAccount).getUser(messageObjecpluschat.russageOwner.media.user_id);
            avatarDrawable.setInfo(currentAccount, user);
            TL_stories.StoryItem storyItem = messageObjecpluschat.russageOwner.media.storyItem;
            ...
            } else if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.action != null) {
                TLRPC.MessageAction action = messageObjecpluschat.russageOwner.action;
            ...
            TLRPC.TL_messageActionSuggestProfilePhoto action = (TLRPC.TL_messageActionSuggestProfilePhoto) messageObjecpluschat.russageOwner.action;
            ...
            TLRPC.Photo photo = messageObjecpluschat.russageOwner.action.photo;
            TLRPC.PhotoSize strippedPhotoSize = null;
            if (messageObject.strippedThumb == null) {
                for (int a = 0, N = messageObject.photoThumbs.size(); a < N; a++) {
                    TLRPC.PhotoSize photoSize = messageObject.photoThumbs.get(a);
            ...
            ImageUpdater imageUpdater = MessagesController.getInstance(currentAccount).photoSuggestion.get(messageObjecpluschat.russageOwner.local_id);
            ...
            if (USE_PREMIUM_GIFT_LOCAL_STICKER) {
                ...
                if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionNoForwardsRequest) {
                    final TLRPC.TL_messageActionNoForwardsRequest action = (TLRPC.TL_messageActionNoForwardsRequest) messageObjecpluschat.russageOwner.action;
                    ...
                    offerExpired = action.expired || messageObjecpluschat.russageOwner.date + requestTtl < ConnectionsManager.getInstance(currentAccount).getCurrentTime();
                ...
                } else if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGiftPurchaseOffer) {
                    final TLRPC.TL_messageActionStarGiftPurchaseOffer action = (TLRPC.TL_messageActionStarGiftPurchaseOffer) messageObjecpluschat.russageOwner.action;
                    ...
                    final TLRPC.TL_messageActionSetChatTheme action = (TLRPC.TL_messageActionSetChatTheme) messageObjecpluschat.russageOwner.action;
                ...
                } else if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGift) {
                    parentObject = messageObject;
                    final TLRPC.TL_messageActionStarGift action = (TLRPC.TL_messageActionStarGift) messageObjecpluschat.russageOwner.action;
                    if (action.gift != null) {
                        document = action.gift.sticker;
                    }
                } else if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGiftUnique && ((TLRPC.TL_messageActionStarGiftUnique) messageObjecpluschat.russageOwner.action).refunded) {
                    parentObject = messageObject;
                    final TLRPC.TL_messageActionStarGiftUnique action = (TLRPC.TL_messageActionStarGiftUnique) messageObjecpluschat.russageOwner.action;
                    if (action.gift != null) {
                        document = action.gift.getDocument();
                    }
                } else {
                    if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
                    ...
                    if (set != null) {
                        parentObject = set;
                        int months = messageObjecpluschat.russageOwner.action.months;
                        String monthsEmoticon;
                        if (messageObject.type == MessageObject.TYPE_GIFT_STARS) {
                            String emoji;
                            if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
                                emoji = StarsIntroActivity.getTonGiftEmoji(messageObjecpluschat.russageOwner.action.cryptoAmount);
                            } else {
                                final long stars;
                                if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftStars) {
                                    stars = ((TLRPC.TL_messageActionGiftStars) messageObjecpluschat.russageOwner.action).stars;
                                } else {
                                    stars = ((TLRPC.TL_messageActionPrizeStars) messageObjecpluschat.russageOwner.action).stars;
                                }
                                if (stars <= 1000) {
                                    emoji = "2⃣";
                                } else if (stars < 2500) {
            ...
            final TLRPC.TL_messageActionChangeCommunity action = (TLRPC.TL_messageActionChangeCommunity) messageObjecpluschat.russageOwner.action;
            ...
            if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionUserUpdatedPhoto) {
                ...
                if (photoSize != null) {
                    ...
                    if (!photo.video_sizes.isEmpty() && SharedConfig.isAutoplayGifs()) {
                        ...
                        if (!messageObjecpluschat.rudiaExists && !DownloadController.getInstance(currentAccount).canDownloadMedia(DownloadController.AUTODOWNLOAD_TYPE_VIDEO, videoSize.size)) {
    ...
    private float getUploadingInfoProgress(MessageObject messageObject) {
        try {
            if (messageObject != null && messageObject.type == MessageObject.TYPE_ACTION_WALLPAPER) {
                ...
                if (messagesController.uploadingWallpaper != null && TextUtils.equals(messageObjecpluschat.russageOwner.action.wallpaper.uploadingImage, messagesController.uploadingWallpaper)) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (delegate != null) {
                ...
                if (!result && TlUtils.isInstance(currentMessageObject != null && currentMessageObjecpluschat.russageOwner != null ? currentMessageObjecpluschat.russageOwner.action : null, TLRPC.TL_messageActionSuggestedPostRefund.class, TLRPC.TL_messageActionSuggestedPostSuccess.class)) {
                    textPressed = true;
                    result = true;
                }
                if (result) {
            ...
            if (actionPressed) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_UP:
                        ...
                        if (delegate != null && messageObject != null && messageObject.replyMessageObject != null && messageObjecpluschat.russageOwner != null && (TlUtils.isInstance(messageObjecpluschat.russageOwner.action, TLRPC.TL_messageActionTodoAppendTasks.class, TLRPC.TL_messageActionTodoCompletions.class, TLRPC.TL_messageActionSuggestedPostApproval.class, TLRPC.TL_messageActionSuggestedPostRefund.class, TLRPC.TL_messageActionSuggestedPostSuccess.class))) {
                        ...
                        if (delegate != null) {
                            if (messageObject.type == MessageObject.TYPE_COMMUNITY_CHANGED) {
                                ...
                                if (lastFragment != null) {
                                    new CommunitySheet(lastFragment, ((TLRPC.TL_messageActionChangeCommunity) messageObjecpluschat.russageOwner.action).community_id)
                                        .show();
                                }
                                ...
                                playSoundEffect(SoundEffectConstants.CLICK);
                                openStarsGiftTransaction();
                            } else if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval && ((TLRPC.TL_messageActionSuggestedPostApproval) messageObjecpluschat.russageOwner.action).balance_too_low) {
                                playSoundEffect(SoundEffectConstants.CLICK);
                                openStarsNeedSheet();
                            } else {
                                ImageUpdater imageUpdater = MessagesController.getInstance(currentAccount).photoSuggestion.get(messageObjecpluschat.russageOwner.local_id);
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN || (pressedLink != null || spoilerPressed != null) && event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (!result && textLayout != null && x >= textX && y >= textY && x <= textX + textWidth && y <= textY + textHeight) {
                    ...
                    if (!result) {
                        ...
                        if (left <= x && left + textLayout.getLineWidth(line) >= x && messageObjecpluschat.russageText instanceof Spannable) {
                            Spannable buffer = (Spannable) messageObjecpluschat.russageText;
    ...
    private void openPremiumGiftChannel() {
        if (delegate != null) {
            TLRPC.TL_messageActionGiftCode gifCodeAction = (TLRPC.TL_messageActionGiftCode) currentMessageObjecpluschat.russageOwner.action;
    ...
    private boolean isSelfGiftCode() {
        if (currentMessageObject != null && (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftCode || currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftStars)) {
            if (currentMessageObjecpluschat.russageOwner.from_id instanceof TLRPC.TL_peerUser) {
                return UserObject.isUserSelf(MessagesController.getInstance(currentAccount).getUser(currentMessageObjecpluschat.russageOwner.from_id.user_id));
            }
        }
        return false;
    }
    ...
    private boolean isGiftCode() {
        return currentMessageObject != null && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftCode;
    }

    private void openPremiumGiftPreview() {
        final TLRPC.TL_premiumGiftOption giftOption = new TLRPC.TL_premiumGiftOption();
        final TLRPC.MessageAction action = currentMessageObjecpluschat.russageOwner.action;
        giftOption.amount = action.amount;
        giftOption.months = action.months;
        giftOption.currency = action.currency;
        String slug;
        if (isGiftCode()) {
            slug = isSelfGiftCode() ? null : ((TLRPC.TL_messageActionGiftCode) currentMessageObjecpluschat.russageOwner.action).slug;
        } else {
            slug = null;
        }
        if (delegate != null) {
    ...
    private void openStarsGiftTransaction() {
        if (currentMessageObject == null || currentMessageObjecpluschat.russageOwner == null) return;
        if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftStars) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObjecpluschat.russageOwner.date, currentMessageObjecpluschat.russageOwner.from_id, currentMessageObjecpluschat.russageOwner.peer_id, (TLRPC.TL_messageActionGiftStars) currentMessageObjecpluschat.russageOwner.action, avatarStoryParams.resourcesProvider);
        } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionPrizeStars) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObjecpluschat.russageOwner.date, currentMessageObjecpluschat.russageOwner.from_id, currentMessageObjecpluschat.russageOwner.peer_id, (TLRPC.TL_messageActionPrizeStars) currentMessageObjecpluschat.russageOwner.action, avatarStoryParams.resourcesProvider);
        } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObjecpluschat.russageOwner.date, currentMessageObjecpluschat.russageOwner.from_id, currentMessageObjecpluschat.russageOwner.peer_id, (TLRPC.TL_messageActionGiftTon) currentMessageObjecpluschat.russageOwner.action, avatarStoryParams.resourcesProvider);
        } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGift) {
            final TLRPC.TL_messageActionStarGift action = (TLRPC.TL_messageActionStarGift) currentMessageObjecpluschat.russageOwner.action;
            if (action.forceIn) return;
//            StarsIntroActivity.showActionGiftSheet(getContext(), currentAccount, currentMessageObject.getDialogId(), currentMessageObject.isOutOwner(), currentMessageObjecpluschat.russageOwner.date, currentMessageObject.getId(), action, themeDelegate);
            new StarGiftSheet(getContext(), currentAccount, currentMessageObject.getDialogId(), themeDelegate)
                .set(currentMessageObject)
                .show();
        } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGiftUnique) {
            final TLRPC.TL_messageActionStarGiftUnique action = (TLRPC.TL_messageActionStarGiftUnique) currentMessageObjecpluschat.russageOwner.action;
            ...
            new StarGiftSheet(getContext(), currentAccount, currentMessageObject.getDialogId(), themeDelegate)
                .set(currentMessageObject)
                .show();
        } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSetChatTheme) {
            TLRPC.TL_messageActionSetChatTheme action = (TLRPC.TL_messageActionSetChatTheme) currentMessageObjecpluschat.russageOwner.action;
    ...
    private void openLink(CharacterStyle link) {
        if (delegate != null && link instanceof URLSpan) {
            ...
            if (url.startsWith("task")) {
                ...
                if (messageObject != null && messageObjecpluschat.russageOwner.reply_markup != null) {
                    for (int a = 0; a < messageObjecpluschat.russageOwner.reply_markup.rows.size(); a++) {
                        TLRPC.TL_keyboardButtonRow row = messageObjecpluschat.russageOwner.reply_markup.rows.get(a);
                        for (int b = 0; b < row.buttons.size(); b++) {
                            TLRPC.KeyboardButton button = row.buttons.get(b);
                            if (button instanceof TLRPC.TL_keyboardButtonGame && button.game_id == currentMessageObjecpluschat.russageOwner.action.game_id) {
                                gameButton = button;
                                break;
                            }
                        }
    ...
    private boolean isMessageActionSuggestedPostApproval() {
        return currentMessageObject != null
            && currentMessageObjecpluschat.russageOwner != null
            && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval;
    }
    ...
    private void createLayout(CharSequence text, int width) {
        ...
        if (currentMessageObject != null
            && currentMessageObjecpluschat.russageOwner != null
            && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval
            && !((TLRPC.TL_messageActionSuggestedPostApproval) currentMessageObjecpluschat.russageOwner.action).rejected
            && !((TLRPC.TL_messageActionSuggestedPostApproval) currentMessageObjecpluschat.russageOwner.action).balance_too_low
        ) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (starGiftLayout.has()) {
            ...
            if (giftPremiumButtonLayout != null) {
                ...
                if (currentMessageObject != null && currentMessageObjecpluschat.russageOwner != null && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGift) {
    ...
    private boolean isNewStyleButtonLayout() {
        return starGiftLayout.has()
            ...
            || (currentMessageObjecpluschat.russageOwner != null && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval && (((TLRPC.TL_messageActionSuggestedPostApproval) currentMessageObjecpluschat.russageOwner.action).balance_too_low || ((TLRPC.TL_messageActionSuggestedPostApproval) currentMessageObjecpluschat.russageOwner.action).rejected));
    }
    ...
    private void buildLayout() {
        ...
        if (messageObject != null) {
            if (messageObject.isExpiredStory()) {
                long dialogId = messageObjecpluschat.russageOwner.media.user_id;
                ...
                TLRPC.TL_forumTopic topic = MessagesController.getInstance(currentAccount).getTopicsController().findTopic(-messageObject.getDialogId(), MessageObject.getTopicId(currentAccount, messageObjecpluschat.russageOwner, true));
                text = ForumUtilities.createActionTextWithTopic(topic, messageObject);
            }
            if (text == null) {
                if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.media != null && messageObjecpluschat.russageOwner.media.ttl_seconds != 0) {
                    if (messageObjecpluschat.russageOwner.media.photo != null) {
                        text = getString(R.string.AttachPhotoExpired);
                    } else if (messageObjecpluschat.russageOwner.media.document instanceof TLRPC.TL_documentEmpty || messageObjecpluschat.russageOwner.media instanceof TLRPC.TL_messageMediaDocument && messageObjecpluschat.russageOwner.media.document == null) {
                        if (messageObjecpluschat.russageOwner.media.voice) {
                            text = getString(R.string.AttachVoiceExpired);
                        } else if (messageObjecpluschat.russageOwner.media.round) {
                            text = getString(R.string.AttachRoundExpired);
                        } else {
                            text = getString(R.string.AttachVideoExpired);
                        }
                    } else {
                        text = AnimatedEmojiSpan.cloneSpans(messageObjecpluschat.russageText);
                    }
                } else {
                    text = AnimatedEmojiSpan.cloneSpans(messageObjecpluschat.russageText);
                }
        ...
        if (currentMessageObject != null && currentMessageObjecpluschat.russageOwner != null && currentMessageObjecpluschat.russageOwner.action != null) {
            int iconResId = 0;
            if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionTodoAppendTasks) {
                iconResId = R.drawable.mini_checklist_add;
            } else if (currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionTodoCompletions) {
                final TLRPC.TL_messageActionTodoCompletions action = (TLRPC.TL_messageActionTodoCompletions) currentMessageObjecpluschat.russageOwner.action;
        ...
        if (messageObject != null) {
            if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval && ((TLRPC.TL_messageActionSuggestedPostApproval) messageObjecpluschat.russageOwner.action).balance_too_low) {
                final TLRPC.TL_messageActionSuggestedPostApproval approval = (TLRPC.TL_messageActionSuggestedPostApproval) messageObjecpluschat.russageOwner.action;
                ...
                textY = 0;
                giftRectEmpty = true;
            } else if (messageObjecpluschat.russageOwner != null && messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionSuggestedPostApproval && ((TLRPC.TL_messageActionSuggestedPostApproval) messageObjecpluschat.russageOwner.action).rejected) {
                final TLRPC.TL_messageActionSuggestedPostApproval approval = (TLRPC.TL_messageActionSuggestedPostApproval) messageObjecpluschat.russageOwner.action;
                ...
                if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftStars) {
                    ...
                    final int within = MessagesController.getInstance(currentAccount).stargiftsConvertPeriodMax - (ConnectionsManager.getInstance(currentAccount).getCurrentTime() - messageObjecpluschat.russageOwner.date);
                    ...
                    createGiftPremiumLayouts(
                        ...
                        true,
                            false);
                } else if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
                    createGiftPremiumLayouts(
                        getString(R.string.ActionGiftTonTitle),
                        null,
                        null, currentMessageObjecpluschat.russageText,
                        false, getString(R.string.ActionGiftStarsView),
                        11, null,
                        giftRectSize,
                        true,
                ...
                final TLRPC.TL_messageActionChangeCommunity action = (TLRPC.TL_messageActionChangeCommunity) messageObjecpluschat.russageOwner.action;
                final long peerId = DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.peer_id);
                final boolean isChannel = ChatObject.isChannelAndNotMegaGroup(-peerId, currentAccount);
                final boolean isBot = peerId > 0;
                final String userName = DialogObject.getShortName(currentAccount, DialogObject.getPeerDialogId(messageObjecpluschat.russageOwner.from_id));
                ...
                if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftPremium) {
                    textWithEntities = ((TLRPC.TL_messageActionGiftPremium) messageObjecpluschat.russageOwner.action).message;
                } else if (messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionGiftCode) {
                    textWithEntities = ((TLRPC.TL_messageActionGiftCode) messageObjecpluschat.russageOwner.action).message;
                }
                ...
                createGiftPremiumLayouts(formatPluralStringComma("ActionGiftPremiumTitle2", messageObjecpluschat.russageOwner.action.months), null, null, messageText, true, actionName, 11, null, giftRectSize, false, false);
            } else if (messageObject.type == MessageObject.TYPE_SUGGEST_PHOTO) {
                TLRPC.TL_messageActionSuggestProfilePhoto actionSuggestProfilePhoto = (TLRPC.TL_messageActionSuggestProfilePhoto) messageObjecpluschat.russageOwner.action;
                String description;
                ...
                if (messageObject.getDialogId() < 0) {
                    description = messageObjecpluschat.russageText;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!starGiftLayout.has() && birthdayLayout == null && isButtonLayout(messageObject)) {
            ...
            if (isNewStyleButtonLayout()) {
                ...
                float y = top;
                if (messageObject.isStoryMention()) {
                    avatarStoryParams.storyItem = messageObjecpluschat.russageOwner.media.storyItem;
                }
                ...
                if (messageObjecpluschat.russageOwner != null && !(messageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGift)) {
                    imageReceiver.setImageCoords((previousWidth - imageSize) / 2f, textY + textHeight + giftRectSize * 0.075f - dp(22), imageSize, imageSize);
                } else {
        ...
        if (starGiftLayout.has()) {
            ...
            if (wallpaperPreviewDrawable != null) {
                ...
                long dialogId = messageObjecpluschat.russageOwner.media.user_id;
                avatarStoryParams.storyId = messageObjecpluschat.russageOwner.media.id;
    ...
    private void didPressCustomBotButton(BotInlineKeyboard.ButtonCustom button) {
        ...
        if (button.id == BotInlineKeyboard.ButtonCustom.GIFT_OFFER_DECLINE) {
            ...
            if (currentMessageObject != null && currentMessageObjecpluschat.russageOwner != null && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionStarGiftPurchaseOffer) {
                TLRPC.TL_messageActionStarGiftPurchaseOffer offer = (TLRPC.TL_messageActionStarGiftPurchaseOffer) currentMessageObjecpluschat.russageOwner.action;
            ...
            final BaseFragment fragment = delegate != null ? delegate.getBaseFragment() : null;
            if (fragment != null && currentMessageObject != null && currentMessageObjecpluschat.russageOwner != null && currentMessageObjecpluschat.russageOwner.action instanceof TLRPC.TL_messageActionNoForwardsRequest) {
                final TLRPC.TL_messageActionNoForwardsRequest action = (TLRPC.TL_messageActionNoForwardsRequest) currentMessageObjecpluschat.russageOwner.action;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (accessibilityText == null) {
            CharSequence text = !TextUtils.isEmpty(customText) ? customText : messageObjecpluschat.russageText;

...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        org.pluschat.ui.Cells.GroupCallUserCell.AvatarWavesDrawable avatarWavesDrawable = new org.pluschat.ui.Cells.GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.dp(26), AndroidUtilities.dp(29));
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (name != null) {
                ...
                float textWidth = textPainpluschat.ruasureText(name);

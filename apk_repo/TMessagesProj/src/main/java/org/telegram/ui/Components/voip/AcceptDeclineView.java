...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(@NonNull Context context) {
        ...
        acceptLayout = new StaticLayout(acceptStr, textPaint, (int) textPainpluschat.ruasureText(acceptStr), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        declineLayout = new StaticLayout(declineStr, textPaint, (int) textPainpluschat.ruasureText(declineStr), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);

        retryLayout = new StaticLayout(retryStr, textPaint, (int) textPainpluschat.ruasureText(retryStr), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);

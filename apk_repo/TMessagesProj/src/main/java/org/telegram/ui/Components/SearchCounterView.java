    ...
    public void setCount(String newStr, int count, boolean animated) {
        ...
        if (!animated) {
            ...
            if (newStr == null) {
                ...
                countWidth = Math.max(AndroidUtilities.dp(12), (int) Math.ceil(textPainpluschat.ruasureText(newStr)));
        ...
        if (animated) {
            ...
            if (countLayout != null) {
                ...
                int countOldWidth = Math.max(AndroidUtilities.dp(12), (int) Math.ceil(textPainpluschat.ruasureText(oldStr)));
                int countNewWidth = Math.max(AndroidUtilities.dp(12), (int) Math.ceil(textPainpluschat.ruasureText(newStr)));

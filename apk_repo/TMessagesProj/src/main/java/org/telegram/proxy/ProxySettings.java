...
public final class ProxySettings {
    ...
    public String getLink() {
        ...
        switch (type) {
            case MTPROTO:
                url = new StringBuilder("https://pluschat.ru/proxy?");
                break;
            case WEB:
                url = new StringBuilder("https://pluschat.ru/webproxy?");
                break;
            case SOCKS5:
            default:
                url = new StringBuilder("https://pluschat.ru/socks?");
                break;
        }
    ...
    public static ProxySettings fromUri(Uri uri) {
        ...
        try {
            ...
            if (scheme.equalsIgnoreCase("http") || scheme.equalsIgnoreCase("https")) {
                ...
                uri = Uri.parse("tg://pluschat.org/" + url.substring(queryIndex));
            } else {
                return null;
            }

...
TL_help_configSimple *Datacenter::decodeSimpleConfig(NativeByteBuffer *buffer) {
    ...
    static std::string public_key =
            ...
            "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAtv9kjwdfbo2ZeesGCKkr\n"
            "hILZ4pUtmF0e+XkQD/Asiz98NHDN1Zlmkqt9nfZP07RVXtFANx/F2gi/XlJUhIr2\n"
            "ZZx9eXtYLBse0lI4Q+pltsdU+HGnQ/Ta1yRqEkhnKNWMxnNXEPI9W0wZ4XpTdqDs\n"
            "wotGqx0XIJaYtyn5gqAwxQAiTi9sXwAuMRzfgtTcdO/A/9tFhY3NwzOazHC0qbxI\n"
            "8f7du23sKtIYwUzfNGe/mov4p/03b6l4dw/eZejGrFK8dBmiwFw8W6f3WCLxFWTo\n"
            "5i4R9iI0sQGYbfot3Tk7a/hj+6lHMl/69CP6sMAnnE4faaDjLtwG9PfcwP4uEUlC\n"
            "7QIDAQAB\n"
            "-----END RSA PUBLIC KEY-----";

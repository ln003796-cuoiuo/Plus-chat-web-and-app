...
public sealed class TlGen_Poll : TlGen_Object {
  public data class TL_poll(
    ...
    public val subscribers_only: Boolean,
    ...
    internal val flags: UInt
      get() {
        ...
        if (subscribers_only) result = result or 2048U
        if (countries_iso2 != null) result = result or 4096U
        return result
      }
    ...
    public companion object {
      public const val MAGIC: UInt = 0x966E2DBFU
    }
  }
  ...
  public data class TL_poll_layer224(
    public val id: Long,
    public val closed: Boolean,
    public val public_voters: Boolean,
    public val multiple_choice: Boolean,

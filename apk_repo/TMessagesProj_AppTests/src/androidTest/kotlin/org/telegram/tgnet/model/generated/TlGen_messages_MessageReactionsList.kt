...
public sealed class TlGen_messages_MessageReactionsList : TlGen_Object {
  public data class TL_messages_messageReactionsList(
    public val count: Int,
    public val reactions: List<TlGen_MessagePeerReaction>,
    public val chats: List<TlGen_Chat>,
    public val users: List<TlGen_User>,
    public val next_offset: String?,
  ) : TlGen_messages_MessageReactionsList() {
    ...
    public companion object {
      public const val MAGIC: UInt = 0x31BD492DU
    }
  }
}

...
public sealed class TlGen_Message : TlGen_Object {
  ...
  public data class TL_message(
    ...
    public val summary_from_language: String?,
    ...
    internal val flags2: UInt
      get() {
        ...
        if (summary_from_language != null) result = result or 2048U
        if (from_rank != null) result = result or 4096U
        if (rich_message != null) result = result or 8192U
        if (guestchat_via_from != null) result = result or 524288U
        return result
      }
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      from_rank?.let { stream.writeString(it) }
      peer_id.serializeToStream(stream)
      saved_peer_id?.serializeToStream(stream)
      ...
      summary_from_language?.let { stream.writeString(it) }
  ...
  public data class TL_message_layer220(
    public val `out`: Boolean,
    public val mentioned: Boolean,
    public val media_unread: Boolean,
    public val silent: Boolean,
  ...
  public data class TL_message_layer222(
    public val `out`: Boolean,
    public val mentioned: Boolean,
    public val media_unread: Boolean,
    public val silent: Boolean,
    ...
    public companion object {
      public const val MAGIC: UInt = 0x9CB490E9U
    }
  }

  public data class TL_message_layer224(
    public val `out`: Boolean,
    public val mentioned: Boolean,
    public val media_unread: Boolean,
    public val silent: Boolean,
    ...
    public companion object {
      public const val MAGIC: UInt = 0x3AE56482U
    }
  }

  public data class TL_message_layer226(
    public val `out`: Boolean,
    public val mentioned: Boolean,
    public val media_unread: Boolean,
    public val silent: Boolean,

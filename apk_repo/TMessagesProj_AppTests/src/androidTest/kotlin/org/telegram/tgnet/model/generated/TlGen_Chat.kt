...
public sealed class TlGen_Chat : TlGen_Object {
  ...
  public data class TL_channel(
    ...
    public val linked_community_id: Long?,
  ) : TlGen_Chat() {
    ...
    internal val flags2: UInt
      get() {
        ...
        if (linked_community_id != null) result = result or 1048576U
        return result
      }
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      linked_community_id?.let { stream.writeInt64(it) }
    }

    public companion object {
      public const val MAGIC: UInt = 0xD49F34C6U
    }
  }

  public data class TL_communityForbidden(
    public val id: Long,
    public val access_hash: Long?,
    public val title: String,
  ) : TlGen_Chat() {
    ...
    public companion object {
      public const val MAGIC: UInt = 0xFD3CDAB8U
    }
  }

  public data class TL_community(
    public val creator: Boolean,
    public val left: Boolean,
    public val min: Boolean,
    public val collapsed_in_dialogs: Boolean,
    public val id: Long,
    public val access_hash: Long?,
    public val title: String,
    public val photo: TlGen_ChatPhoto,
    ...
    internal val flags2: UInt
      get() {
        var result = 0U
        if (collapsed_in_dialogs) result = result or 1048576U
        return result
      }
    ...
    public companion object {
      public const val MAGIC: UInt = 0x65EFE954U
    }
  }
  ...
  public data class TL_channel_layer227(
    public val creator: Boolean,
    public val left: Boolean,
    public val broadcast: Boolean,
    public val verified: Boolean,

...
public sealed class TlGen_InputBusinessBotRecipients : TlGen_Object {
  public data class TL_inputBusinessBotRecipients(
    ...
    public val exclude_users: List<TlGen_InputUser>?,
  ) : TlGen_InputBusinessBotRecipients() {
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      exclude_users?.let { TlGen_Vector.serialize(stream, it) }
    }

    public companion object {
      public const val MAGIC: UInt = 0xC4E5921EU
    }
  }
}

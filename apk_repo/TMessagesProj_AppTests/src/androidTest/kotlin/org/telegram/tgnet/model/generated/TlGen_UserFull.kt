...
public sealed class TlGen_UserFull : TlGen_Object {
  public data class TL_userFull(
    ...
    public val unofficial_security_risk: Boolean,
    public val id: Long,
    ...
    public val bot_manager_id: Long?,
    ...
    internal val flags2: UInt
      get() {
        ...
        if (bot_manager_id != null) result = result or 33554432U
        if (unofficial_security_risk) result = result or 67108864U
        return result
      }
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      bot_manager_id?.let { stream.writeInt64(it) }
    }
    ...
    public companion object {
      public const val MAGIC: UInt = 0x06CBE645U
    }
  }
  ...
  public data class TL_userFull_layer223(
    public val blocked: Boolean,
    public val phone_calls_available: Boolean,
    public val phone_calls_private: Boolean,
    public val can_pin_message: Boolean,

...
public sealed class TlGen_KeyboardButton : TlGen_Object {
  public data class TL_keyboardButton(
    ...
    public val type: TlGen_ButtonType,
    ...
    public companion object {
      public const val MAGIC: UInt = 0x2F67A72FU
    }
  }
  ...
  public data class TL_inputKeyboardButtonRequestPeer_layer221(
    ...
    public companion object {
      public const val MAGIC: UInt = 0xC9662D05U
    }
  }
  ...
  public data class TL_keyboardButton_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
  ) : TlGen_Object {
    internal val flags: UInt
  ...
  public data class TL_keyboardButtonUrl_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val url: String,
  ) : TlGen_Object {
  ...
  public data class TL_keyboardButtonCallback_layer228(
    public val requires_password: Boolean,
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val `data`: List<Byte>,
  ...
  public data class TL_keyboardButtonRequestPhone_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
  ) : TlGen_Object {
    internal val flags: UInt
  ...
  public data class TL_keyboardButtonRequestGeoLocation_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
  ) : TlGen_Object {
    internal val flags: UInt
  ...
  public data class TL_keyboardButtonSwitchInline_layer228(
    public val same_peer: Boolean,
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val query: String,
  ...
  public data class TL_keyboardButtonGame_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
  ) : TlGen_Object {
    internal val flags: UInt
  ...
  public data class TL_keyboardButtonBuy_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
  ) : TlGen_Object {
    internal val flags: UInt
  ...
  public data class TL_keyboardButtonUrlAuth_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val fwd_text: String?,
    public val url: String,
  ...
  public data class TL_inputKeyboardButtonUrlAuth_layer228(
    public val request_write_access: Boolean,
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val fwd_text: String?,
  ...
  public data class TL_keyboardButtonRequestPoll_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val quiz: Boolean?,
    public val text: String,
  ) : TlGen_Object {
  ...
  public data class TL_inputKeyboardButtonUserProfile_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val user_id: TlGen_InputUser,
  ) : TlGen_Object {
  ...
  public data class TL_keyboardButtonUserProfile_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val user_id: Long,
  ) : TlGen_Object {
  ...
  public data class TL_keyboardButtonWebView_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val url: String,
  ) : TlGen_Object {
  ...
  public data class TL_keyboardButtonSimpleWebView_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val url: String,
  ) : TlGen_Object {
  ...
  public data class TL_keyboardButtonRequestPeer_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val button_id: Int,
    public val peer_type: TlGen_RequestPeerType,
  ...
  public data class TL_inputKeyboardButtonRequestPeer_layer228(
    public val name_requested: Boolean,
    public val username_requested: Boolean,
    public val photo_requested: Boolean,
    public val style: TlGen_KeyboardButtonStyle?,
    ...
    public companion object {
      public const val MAGIC: UInt = 0x02B78156U
    }
  }

  public data class TL_keyboardButtonCopy_layer228(
    public val style: TlGen_KeyboardButtonStyle?,
    public val text: String,
    public val copy_text: String,
  ) : TlGen_Object {
